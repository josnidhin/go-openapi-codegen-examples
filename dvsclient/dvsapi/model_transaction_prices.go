...
// checks if the TransactionPrices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionPrices{}
...
func (o *TransactionPrices) GetWholesale() TransactionPricesWholesale {
	if o == nil {
		var ret TransactionPricesWholesale
		return ret
	}
...
// If the value is explicit nil, the zero value for TransactionPricesRetail will be returned
func (o *TransactionPrices) GetRetail() TransactionPricesRetail {
	if o == nil || o.Retail.Get() == nil {
		var ret TransactionPricesRetail
		return ret
	}
...
func (o TransactionPrices) MarshalJSON() ([]byte, error) {
...
func (o TransactionPrices) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionPrices struct {
	value *TransactionPrices
	isSet bool
}

func (v NullableTransactionPrices) Get() *TransactionPrices {
	return v.value
}

func (v *NullableTransactionPrices) Set(val *TransactionPrices) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionPrices) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionPrices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionPrices(val *TransactionPrices) *NullableTransactionPrices {
	return &NullableTransactionPrices{value: val, isSet: true}
}

func (v NullableTransactionPrices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionPrices) UnmarshalJSON(src []byte) error {
	v.isSet = true
