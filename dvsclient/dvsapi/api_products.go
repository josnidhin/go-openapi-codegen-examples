...
func (r ProductsApiProductsGetRequest) ServiceId(serviceId int32) ProductsApiProductsGetRequest {
	r.serviceId = &serviceId
	return r
}

func (r ProductsApiProductsGetRequest) Tags(tags []string) ProductsApiProductsGetRequest {
	r.tags = &tags
	return r
}

func (r ProductsApiProductsGetRequest) CountryIsoCode(countryIsoCode string) ProductsApiProductsGetRequest {
	r.countryIsoCode = &countryIsoCode
	return r
}

func (r ProductsApiProductsGetRequest) OperatorId(operatorId int32) ProductsApiProductsGetRequest {
	r.operatorId = &operatorId
	return r
}

func (r ProductsApiProductsGetRequest) Region(region string) ProductsApiProductsGetRequest {
	r.region = &region
	return r
}

func (r ProductsApiProductsGetRequest) BenefitTypes(benefitTypes []BenefitTypes) ProductsApiProductsGetRequest {
	r.benefitTypes = &benefitTypes
	return r
}

// Page number
func (r ProductsApiProductsGetRequest) Page(page int32) ProductsApiProductsGetRequest {
	r.page = &page
	return r
}

// Number of records per page
func (r ProductsApiProductsGetRequest) PerPage(perPage int32) ProductsApiProductsGetRequest {
	r.perPage = &perPage
	return r
}

func (r ProductsApiProductsGetRequest) Execute() ([]Product, *http.Response, error) {
