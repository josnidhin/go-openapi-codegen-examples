...
func (r ProductsApiGetProductsRequest) SubserviceId(subserviceId int32) ProductsApiGetProductsRequest {
...
func (a *ProductsApiService) GetProductsExecute(r ProductsApiGetProductsRequest) ([]Product, *http.Response, error) {
	...
	if r.benefitTypes != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "benefit_types", r.benefitTypes, "csv")
	}
	if r.page != nil {
