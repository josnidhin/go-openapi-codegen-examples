...
// checks if the TransactionProductAllOfPin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionProductAllOfPin{}
...
func NewTransactionProductAllOfPin(usageInfo []string, validity NullablePINValidity, terms NullableString) *TransactionProductAllOfPin {
	this := TransactionProductAllOfPin{}
...
// If the value is explicit nil, the zero value for PINValidity will be returned
...
func (o TransactionProductAllOfPin) MarshalJSON() ([]byte, error) {
...
func (o TransactionProductAllOfPin) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionProductAllOfPin struct {
	value *TransactionProductAllOfPin
	isSet bool
}

func (v NullableTransactionProductAllOfPin) Get() *TransactionProductAllOfPin {
	return v.value
}

func (v *NullableTransactionProductAllOfPin) Set(val *TransactionProductAllOfPin) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionProductAllOfPin) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionProductAllOfPin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionProductAllOfPin(val *TransactionProductAllOfPin) *NullableTransactionProductAllOfPin {
	return &NullableTransactionProductAllOfPin{value: val, isSet: true}
}

func (v NullableTransactionProductAllOfPin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionProductAllOfPin) UnmarshalJSON(src []byte) error {
	v.isSet = true
