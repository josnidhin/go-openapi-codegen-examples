...
// checks if the ProductRangedValuePinPurchase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductRangedValuePinPurchase{}
...
func (o ProductRangedValuePinPurchase) ToMap() (map[string]interface{}, error) {
