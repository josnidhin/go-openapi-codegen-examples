...
func (o *ProductRangedValuePinPurchase) GetOperator() OperatorsGet200ResponseInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ProductRangedValuePinPurchase) GetOperatorOk() (*OperatorsGet200ResponseInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProductRangedValuePinPurchase) SetOperator(v OperatorsGet200ResponseInner) {
	o.Operator = v
}
...
func (o ProductRangedValuePinPurchase) MarshalJSON() ([]byte, error) {
...
type NullableProductRangedValuePinPurchase struct {
	value *ProductRangedValuePinPurchase
	isSet bool
}

func (v NullableProductRangedValuePinPurchase) Get() *ProductRangedValuePinPurchase {
	return v.value
}

func (v *NullableProductRangedValuePinPurchase) Set(val *ProductRangedValuePinPurchase) {
	v.value = val
	v.isSet = true
}

func (v NullableProductRangedValuePinPurchase) IsSet() bool {
	return v.isSet
}

func (v *NullableProductRangedValuePinPurchase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductRangedValuePinPurchase(val *ProductRangedValuePinPurchase) *NullableProductRangedValuePinPurchase {
	return &NullableProductRangedValuePinPurchase{value: val, isSet: true}
}

func (v NullableProductRangedValuePinPurchase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductRangedValuePinPurchase) UnmarshalJSON(src []byte) error {
	v.isSet = true
