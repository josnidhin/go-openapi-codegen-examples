...
func NewLookupStatementInquiryPostRequest(productId int32, accountNumber string) *LookupStatementInquiryPostRequest {
	this := LookupStatementInquiryPostRequest{}
...
func (o LookupStatementInquiryPostRequest) MarshalJSON() ([]byte, error) {
...
type NullableLookupStatementInquiryPostRequest struct {
	value *LookupStatementInquiryPostRequest
	isSet bool
}

func (v NullableLookupStatementInquiryPostRequest) Get() *LookupStatementInquiryPostRequest {
	return v.value
}

func (v *NullableLookupStatementInquiryPostRequest) Set(val *LookupStatementInquiryPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableLookupStatementInquiryPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableLookupStatementInquiryPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLookupStatementInquiryPostRequest(val *LookupStatementInquiryPostRequest) *NullableLookupStatementInquiryPostRequest {
	return &NullableLookupStatementInquiryPostRequest{value: val, isSet: true}
}

func (v NullableLookupStatementInquiryPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLookupStatementInquiryPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
