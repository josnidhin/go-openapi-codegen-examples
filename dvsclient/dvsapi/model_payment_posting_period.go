...
// checks if the PaymentPostingPeriod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentPostingPeriod{}
...
func (o PaymentPostingPeriod) MarshalJSON() ([]byte, error) {
...
func (o PaymentPostingPeriod) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentPostingPeriod struct {
	value *PaymentPostingPeriod
	isSet bool
}

func (v NullablePaymentPostingPeriod) Get() *PaymentPostingPeriod {
	return v.value
}

func (v *NullablePaymentPostingPeriod) Set(val *PaymentPostingPeriod) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentPostingPeriod) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentPostingPeriod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentPostingPeriod(val *PaymentPostingPeriod) *NullablePaymentPostingPeriod {
	return &NullablePaymentPostingPeriod{value: val, isSet: true}
}

func (v NullablePaymentPostingPeriod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentPostingPeriod) UnmarshalJSON(src []byte) error {
	v.isSet = true
