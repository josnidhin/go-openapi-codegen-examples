...
// checks if the TransactionDestination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionDestination{}

// TransactionDestination Required for ranged value products and when `calculation_mode` is set to `DESTINATION_AMOUNT`
...
func (o TransactionDestination) MarshalJSON() ([]byte, error) {
...
func (o TransactionDestination) ToMap() (map[string]interface{}, error) {
