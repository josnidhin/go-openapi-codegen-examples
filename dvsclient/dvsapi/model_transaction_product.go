...
// checks if the TransactionProduct type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionProduct{}
...
func NewTransactionProduct(id int32, name string, description string, tags []string, service ProductService, operator GetOperators200ResponseInner, regions []ServiceRegion) *TransactionProduct {
...
func (o *TransactionProduct) GetService() ProductService {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TransactionProduct) GetServiceOk() (*ProductService, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TransactionProduct) SetService(v ProductService) {
	o.Service = v
}
...
func (o *TransactionProduct) GetPin() TransactionProductAllOfPin {
	if o == nil || IsNil(o.Pin) {
		var ret TransactionProductAllOfPin
		return ret
	}
	return *o.Pin
}
...
// SetPin gets a reference to the given TransactionProductAllOfPin and assigns it to the Pin field.
func (o *TransactionProduct) SetPin(v TransactionProductAllOfPin) {
	o.Pin = &v
}

func (o TransactionProduct) MarshalJSON() ([]byte, error) {
...
func (o TransactionProduct) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionProduct struct {
	value *TransactionProduct
	isSet bool
}

func (v NullableTransactionProduct) Get() *TransactionProduct {
	return v.value
}

func (v *NullableTransactionProduct) Set(val *TransactionProduct) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionProduct) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionProduct) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionProduct(val *TransactionProduct) *NullableTransactionProduct {
	return &NullableTransactionProduct{value: val, isSet: true}
}

func (v NullableTransactionProduct) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionProduct) UnmarshalJSON(src []byte) error {
	v.isSet = true
