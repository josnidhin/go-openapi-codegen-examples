...
// TimeUnitTypes the model 'TimeUnitTypes'
type TimeUnitTypes string

// List of TimeUnitTypes
const (
	TIMEUNITTYPES_BUSINESS TimeUnitTypes = "BUSINESS"
	TIMEUNITTYPES_CALENDAR TimeUnitTypes = "CALENDAR"
)

// All allowed values of TimeUnitTypes enum
var AllowedTimeUnitTypesEnumValues = []TimeUnitTypes{
	"BUSINESS",
	"CALENDAR",
}

func (v *TimeUnitTypes) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := TimeUnitTypes(value)
	for _, existing := range AllowedTimeUnitTypesEnumValues {
	...
	return fmt.Errorf("%+v is not a valid TimeUnitTypes", value)
}

// NewTimeUnitTypesFromValue returns a pointer to a valid TimeUnitTypes
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewTimeUnitTypesFromValue(v string) (*TimeUnitTypes, error) {
	ev := TimeUnitTypes(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for TimeUnitTypes: valid values are %v", v, AllowedTimeUnitTypesEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v TimeUnitTypes) IsValid() bool {
	for _, existing := range AllowedTimeUnitTypesEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to TimeUnitTypes value
func (v TimeUnitTypes) Ptr() *TimeUnitTypes {
	return &v
}

type NullableTimeUnitTypes struct {
	value *TimeUnitTypes
	isSet bool
}

func (v NullableTimeUnitTypes) Get() *TimeUnitTypes {
	return v.value
}

func (v *NullableTimeUnitTypes) Set(val *TimeUnitTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeUnitTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeUnitTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeUnitTypes(val *TimeUnitTypes) *NullableTimeUnitTypes {
	return &NullableTimeUnitTypes{value: val, isSet: true}
}

func (v NullableTimeUnitTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeUnitTypes) UnmarshalJSON(src []byte) error {
	v.isSet = true
