...
// checks if the TransactionSource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionSource{}
...
func (o TransactionSource) MarshalJSON() ([]byte, error) {
...
func (o TransactionSource) ToMap() (map[string]interface{}, error) {
