...
// AvailabilityZones the model 'AvailabilityZones'
...
// All allowed values of AvailabilityZones enum
var AllowedAvailabilityZonesEnumValues = []AvailabilityZones{
	"DOMESTIC",
	"INTERNATIONAL",
}

func (v *AvailabilityZones) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := AvailabilityZones(value)
	for _, existing := range AllowedAvailabilityZonesEnumValues {
	...
	return fmt.Errorf("%+v is not a valid AvailabilityZones", value)
}

// NewAvailabilityZonesFromValue returns a pointer to a valid AvailabilityZones
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewAvailabilityZonesFromValue(v string) (*AvailabilityZones, error) {
	ev := AvailabilityZones(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for AvailabilityZones: valid values are %v", v, AllowedAvailabilityZonesEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v AvailabilityZones) IsValid() bool {
	for _, existing := range AllowedAvailabilityZonesEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to AvailabilityZones value
func (v AvailabilityZones) Ptr() *AvailabilityZones {
	return &v
}

type NullableAvailabilityZones struct {
	value *AvailabilityZones
	isSet bool
}

func (v NullableAvailabilityZones) Get() *AvailabilityZones {
	return v.value
}

func (v *NullableAvailabilityZones) Set(val *AvailabilityZones) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailabilityZones) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailabilityZones) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailabilityZones(val *AvailabilityZones) *NullableAvailabilityZones {
	return &NullableAvailabilityZones{value: val, isSet: true}
}

func (v NullableAvailabilityZones) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailabilityZones) UnmarshalJSON(src []byte) error {
	v.isSet = true
