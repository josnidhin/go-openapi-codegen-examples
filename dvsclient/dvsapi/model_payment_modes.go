...
// PaymentModes the model 'PaymentModes'
type PaymentModes string
...
// All allowed values of PaymentModes enum
var AllowedPaymentModesEnumValues = []PaymentModes{
	"PARTIAL",
	"EXACT",
	"EXCESS",
	"PAST_DUE",
...
func (v *PaymentModes) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PaymentModes(value)
	for _, existing := range AllowedPaymentModesEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PaymentModes", value)
}

// NewPaymentModesFromValue returns a pointer to a valid PaymentModes
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPaymentModesFromValue(v string) (*PaymentModes, error) {
	ev := PaymentModes(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PaymentModes: valid values are %v", v, AllowedPaymentModesEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PaymentModes) IsValid() bool {
	for _, existing := range AllowedPaymentModesEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PaymentModes value
func (v PaymentModes) Ptr() *PaymentModes {
	return &v
}

type NullablePaymentModes struct {
	value *PaymentModes
	isSet bool
}

func (v NullablePaymentModes) Get() *PaymentModes {
	return v.value
}

func (v *NullablePaymentModes) Set(val *PaymentModes) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentModes) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentModes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentModes(val *PaymentModes) *NullablePaymentModes {
	return &NullablePaymentModes{value: val, isSet: true}
}

func (v NullablePaymentModes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentModes) UnmarshalJSON(src []byte) error {
	v.isSet = true
