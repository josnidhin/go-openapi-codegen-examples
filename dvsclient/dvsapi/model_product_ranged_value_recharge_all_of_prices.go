...
// checks if the ProductRangedValueRechargeAllOfPrices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductRangedValueRechargeAllOfPrices{}

// ProductRangedValueRechargeAllOfPrices struct for ProductRangedValueRechargeAllOfPrices
type ProductRangedValueRechargeAllOfPrices struct {
	Wholesale ProductRangedValueRechargeAllOfPricesWholesale      `json:"wholesale"`
	Retail    NullableProductRangedValueRechargeAllOfPricesRetail `json:"retail"`
}
...
func NewProductRangedValueRechargeAllOfPrices(wholesale ProductRangedValueRechargeAllOfPricesWholesale, retail NullableProductRangedValueRechargeAllOfPricesRetail) *ProductRangedValueRechargeAllOfPrices {
	this := ProductRangedValueRechargeAllOfPrices{}
...
// GetWholesaleOk returns a tuple with the Wholesale field value
...
// SetWholesale sets field value
func (o *ProductRangedValueRechargeAllOfPrices) SetWholesale(v ProductRangedValueRechargeAllOfPricesWholesale) {
	o.Wholesale = v
}

// GetRetail returns the Retail field value
// If the value is explicit nil, the zero value for ProductRangedValueRechargeAllOfPricesRetail will be returned
func (o *ProductRangedValueRechargeAllOfPrices) GetRetail() ProductRangedValueRechargeAllOfPricesRetail {
	if o == nil || o.Retail.Get() == nil {
		var ret ProductRangedValueRechargeAllOfPricesRetail
		return ret
	}
...
// GetRetailOk returns a tuple with the Retail field value
// and a boolean to check if the value has been set.
...
func (o *ProductRangedValueRechargeAllOfPrices) GetRetailOk() (*ProductRangedValueRechargeAllOfPricesRetail, bool) {
	...
	return o.Retail.Get(), o.Retail.IsSet()
}

// SetRetail sets field value
func (o *ProductRangedValueRechargeAllOfPrices) SetRetail(v ProductRangedValueRechargeAllOfPricesRetail) {
	o.Retail.Set(&v)
}

func (o ProductRangedValueRechargeAllOfPrices) MarshalJSON() ([]byte, error) {
...
func (o ProductRangedValueRechargeAllOfPrices) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["wholesale"] = o.Wholesale
	toSerialize["retail"] = o.Retail.Get()
	return toSerialize, nil
}

type NullableProductRangedValueRechargeAllOfPrices struct {
	value *ProductRangedValueRechargeAllOfPrices
	isSet bool
}

func (v NullableProductRangedValueRechargeAllOfPrices) Get() *ProductRangedValueRechargeAllOfPrices {
	return v.value
}

func (v *NullableProductRangedValueRechargeAllOfPrices) Set(val *ProductRangedValueRechargeAllOfPrices) {
	v.value = val
	v.isSet = true
}

func (v NullableProductRangedValueRechargeAllOfPrices) IsSet() bool {
	return v.isSet
}

func (v *NullableProductRangedValueRechargeAllOfPrices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductRangedValueRechargeAllOfPrices(val *ProductRangedValueRechargeAllOfPrices) *NullableProductRangedValueRechargeAllOfPrices {
	return &NullableProductRangedValueRechargeAllOfPrices{value: val, isSet: true}
}

func (v NullableProductRangedValueRechargeAllOfPrices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductRangedValueRechargeAllOfPrices) UnmarshalJSON(src []byte) error {
	v.isSet = true
