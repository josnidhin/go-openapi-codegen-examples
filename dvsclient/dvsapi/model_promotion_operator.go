...
// checks if the PromotionOperator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionOperator{}
...
func (o *PromotionOperator) GetCountry() PromotionOperatorCountry {
	if o == nil {
		var ret PromotionOperatorCountry
		return ret
	}
...
func (o PromotionOperator) MarshalJSON() ([]byte, error) {
...
func (o PromotionOperator) ToMap() (map[string]interface{}, error) {
...
type NullablePromotionOperator struct {
	value *PromotionOperator
	isSet bool
}

func (v NullablePromotionOperator) Get() *PromotionOperator {
	return v.value
}

func (v *NullablePromotionOperator) Set(val *PromotionOperator) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionOperator) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionOperator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotionOperator(val *PromotionOperator) *NullablePromotionOperator {
	return &NullablePromotionOperator{value: val, isSet: true}
}

func (v NullablePromotionOperator) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotionOperator) UnmarshalJSON(src []byte) error {
	v.isSet = true
