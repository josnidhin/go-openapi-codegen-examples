...
// checks if the TransactionSender type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionSender{}
...
// GetNationalityCountryIsoCode returns the NationalityCountryIsoCode field value if set, zero value otherwise.
func (o *TransactionSender) GetNationalityCountryIsoCode() string {
	if o == nil || IsNil(o.NationalityCountryIsoCode) {
		var ret string
		return ret
	}
	return *o.NationalityCountryIsoCode
}

// GetNationalityCountryIsoCodeOk returns a tuple with the NationalityCountryIsoCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransactionSender) GetNationalityCountryIsoCodeOk() (*string, bool) {
	if o == nil || IsNil(o.NationalityCountryIsoCode) {
		return nil, false
	}
	return o.NationalityCountryIsoCode, true
}
...
// SetNationalityCountryIsoCode gets a reference to the given string and assigns it to the NationalityCountryIsoCode field.
func (o *TransactionSender) SetNationalityCountryIsoCode(v string) {
	o.NationalityCountryIsoCode = &v
}
...
// GetAddressCountryIsoCode returns the AddressCountryIsoCode field value if set, zero value otherwise.
func (o *TransactionSender) GetAddressCountryIsoCode() string {
	if o == nil || IsNil(o.AddressCountryIsoCode) {
		var ret string
		return ret
	}
	return *o.AddressCountryIsoCode
}

// GetAddressCountryIsoCodeOk returns a tuple with the AddressCountryIsoCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransactionSender) GetAddressCountryIsoCodeOk() (*string, bool) {
	if o == nil || IsNil(o.AddressCountryIsoCode) {
		return nil, false
	}
	return o.AddressCountryIsoCode, true
}
...
// SetAddressCountryIsoCode gets a reference to the given string and assigns it to the AddressCountryIsoCode field.
func (o *TransactionSender) SetAddressCountryIsoCode(v string) {
	o.AddressCountryIsoCode = &v
}
...
func (o TransactionSender) MarshalJSON() ([]byte, error) {
...
func (o TransactionSender) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NationalityCountryIsoCode) {
		toSerialize["nationality_country_iso_code"] = o.NationalityCountryIsoCode
	}
	...
	if !IsNil(o.AddressText) {
		toSerialize["address_text"] = o.AddressText
	}
	if !IsNil(o.AddressCity) {
		toSerialize["address_city"] = o.AddressCity
	}
	if !IsNil(o.AddressCountryIsoCode) {
		toSerialize["address_country_iso_code"] = o.AddressCountryIsoCode
	}
...
type NullableTransactionSender struct {
	value *TransactionSender
	isSet bool
}

func (v NullableTransactionSender) Get() *TransactionSender {
	return v.value
}

func (v *NullableTransactionSender) Set(val *TransactionSender) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionSender) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionSender) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionSender(val *TransactionSender) *NullableTransactionSender {
	return &NullableTransactionSender{value: val, isSet: true}
}

func (v NullableTransactionSender) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionSender) UnmarshalJSON(src []byte) error {
	v.isSet = true
