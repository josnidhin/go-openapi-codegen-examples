...
// checks if the TransactionDebitPartyIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionDebitPartyIdentifier{}

// TransactionDebitPartyIdentifier struct for TransactionDebitPartyIdentifier
type TransactionDebitPartyIdentifier struct {
...
func NewTransactionDebitPartyIdentifier() *TransactionDebitPartyIdentifier {
	this := TransactionDebitPartyIdentifier{}
	return &this
}
...
func (o *TransactionDebitPartyIdentifier) GetAccountQualifier() string {
	if o == nil || IsNil(o.AccountQualifier) {
		var ret string
		return ret
	}
...
func (o TransactionDebitPartyIdentifier) MarshalJSON() ([]byte, error) {
...
func (o TransactionDebitPartyIdentifier) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AccountQualifier) {
		toSerialize["account_qualifier"] = o.AccountQualifier
	}
	return toSerialize, nil
}

type NullableTransactionDebitPartyIdentifier struct {
	value *TransactionDebitPartyIdentifier
	isSet bool
}

func (v NullableTransactionDebitPartyIdentifier) Get() *TransactionDebitPartyIdentifier {
	return v.value
}

func (v *NullableTransactionDebitPartyIdentifier) Set(val *TransactionDebitPartyIdentifier) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionDebitPartyIdentifier) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionDebitPartyIdentifier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionDebitPartyIdentifier(val *TransactionDebitPartyIdentifier) *NullableTransactionDebitPartyIdentifier {
	return &NullableTransactionDebitPartyIdentifier{value: val, isSet: true}
}

func (v NullableTransactionDebitPartyIdentifier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionDebitPartyIdentifier) UnmarshalJSON(src []byte) error {
	v.isSet = true
