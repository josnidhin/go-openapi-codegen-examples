...
// checks if the ServiceRegion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceRegion{}

// ServiceRegion struct for ServiceRegion
...
func (o ServiceRegion) MarshalJSON() ([]byte, error) {
...
func (o ServiceRegion) ToMap() (map[string]interface{}, error) {
...
type NullableServiceRegion struct {
	value *ServiceRegion
	isSet bool
}

func (v NullableServiceRegion) Get() *ServiceRegion {
	return v.value
}

func (v *NullableServiceRegion) Set(val *ServiceRegion) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceRegion) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceRegion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceRegion(val *ServiceRegion) *NullableServiceRegion {
	return &NullableServiceRegion{value: val, isSet: true}
}

func (v NullableServiceRegion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceRegion) UnmarshalJSON(src []byte) error {
	v.isSet = true
