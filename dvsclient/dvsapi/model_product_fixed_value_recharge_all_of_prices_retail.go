...
// checks if the ProductFixedValueRechargeAllOfPricesRetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductFixedValueRechargeAllOfPricesRetail{}

// ProductFixedValueRechargeAllOfPricesRetail struct for ProductFixedValueRechargeAllOfPricesRetail
type ProductFixedValueRechargeAllOfPricesRetail struct {
...
func NewProductFixedValueRechargeAllOfPricesRetail(unitType UnitTypes, unit NullableString, amount NullableFloat32, fee NullableFloat32) *ProductFixedValueRechargeAllOfPricesRetail {
	this := ProductFixedValueRechargeAllOfPricesRetail{}
...
func (o ProductFixedValueRechargeAllOfPricesRetail) MarshalJSON() ([]byte, error) {
...
func (o ProductFixedValueRechargeAllOfPricesRetail) ToMap() (map[string]interface{}, error) {
...
type NullableProductFixedValueRechargeAllOfPricesRetail struct {
	value *ProductFixedValueRechargeAllOfPricesRetail
	isSet bool
}

func (v NullableProductFixedValueRechargeAllOfPricesRetail) Get() *ProductFixedValueRechargeAllOfPricesRetail {
	return v.value
}

func (v *NullableProductFixedValueRechargeAllOfPricesRetail) Set(val *ProductFixedValueRechargeAllOfPricesRetail) {
	v.value = val
	v.isSet = true
}

func (v NullableProductFixedValueRechargeAllOfPricesRetail) IsSet() bool {
	return v.isSet
}

func (v *NullableProductFixedValueRechargeAllOfPricesRetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductFixedValueRechargeAllOfPricesRetail(val *ProductFixedValueRechargeAllOfPricesRetail) *NullableProductFixedValueRechargeAllOfPricesRetail {
	return &NullableProductFixedValueRechargeAllOfPricesRetail{value: val, isSet: true}
}

func (v NullableProductFixedValueRechargeAllOfPricesRetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductFixedValueRechargeAllOfPricesRetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
