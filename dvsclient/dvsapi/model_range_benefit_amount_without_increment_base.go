...
// checks if the RangeBenefitAmountWithoutIncrementBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangeBenefitAmountWithoutIncrementBase{}

// RangeBenefitAmountWithoutIncrementBase struct for RangeBenefitAmountWithoutIncrementBase
type RangeBenefitAmountWithoutIncrementBase struct {
...
func NewRangeBenefitAmountWithoutIncrementBase(min float32, max float32) *RangeBenefitAmountWithoutIncrementBase {
	this := RangeBenefitAmountWithoutIncrementBase{}
	this.Min = min
	this.Max = max
	return &this
}
...
func (o RangeBenefitAmountWithoutIncrementBase) MarshalJSON() ([]byte, error) {
...
func (o RangeBenefitAmountWithoutIncrementBase) ToMap() (map[string]interface{}, error) {
...
type NullableRangeBenefitAmountWithoutIncrementBase struct {
	value *RangeBenefitAmountWithoutIncrementBase
	isSet bool
}

func (v NullableRangeBenefitAmountWithoutIncrementBase) Get() *RangeBenefitAmountWithoutIncrementBase {
	return v.value
}

func (v *NullableRangeBenefitAmountWithoutIncrementBase) Set(val *RangeBenefitAmountWithoutIncrementBase) {
	v.value = val
	v.isSet = true
}

func (v NullableRangeBenefitAmountWithoutIncrementBase) IsSet() bool {
	return v.isSet
}

func (v *NullableRangeBenefitAmountWithoutIncrementBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangeBenefitAmountWithoutIncrementBase(val *RangeBenefitAmountWithoutIncrementBase) *NullableRangeBenefitAmountWithoutIncrementBase {
	return &NullableRangeBenefitAmountWithoutIncrementBase{value: val, isSet: true}
}

func (v NullableRangeBenefitAmountWithoutIncrementBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangeBenefitAmountWithoutIncrementBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
