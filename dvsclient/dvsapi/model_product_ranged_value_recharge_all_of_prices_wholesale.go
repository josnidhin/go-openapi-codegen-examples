...
// checks if the ProductRangedValueRechargeAllOfPricesWholesale type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductRangedValueRechargeAllOfPricesWholesale{}
...
func NewProductRangedValueRechargeAllOfPricesWholesale(unitType UnitTypes, unit string, amount RangeWithoutIncrement, fee float32) *ProductRangedValueRechargeAllOfPricesWholesale {
	this := ProductRangedValueRechargeAllOfPricesWholesale{}
...
func (o ProductRangedValueRechargeAllOfPricesWholesale) MarshalJSON() ([]byte, error) {
...
func (o ProductRangedValueRechargeAllOfPricesWholesale) ToMap() (map[string]interface{}, error) {
...
type NullableProductRangedValueRechargeAllOfPricesWholesale struct {
	value *ProductRangedValueRechargeAllOfPricesWholesale
	isSet bool
}

func (v NullableProductRangedValueRechargeAllOfPricesWholesale) Get() *ProductRangedValueRechargeAllOfPricesWholesale {
	return v.value
}

func (v *NullableProductRangedValueRechargeAllOfPricesWholesale) Set(val *ProductRangedValueRechargeAllOfPricesWholesale) {
	v.value = val
	v.isSet = true
}

func (v NullableProductRangedValueRechargeAllOfPricesWholesale) IsSet() bool {
	return v.isSet
}

func (v *NullableProductRangedValueRechargeAllOfPricesWholesale) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductRangedValueRechargeAllOfPricesWholesale(val *ProductRangedValueRechargeAllOfPricesWholesale) *NullableProductRangedValueRechargeAllOfPricesWholesale {
	return &NullableProductRangedValueRechargeAllOfPricesWholesale{value: val, isSet: true}
}

func (v NullableProductRangedValueRechargeAllOfPricesWholesale) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductRangedValueRechargeAllOfPricesWholesale) UnmarshalJSON(src []byte) error {
	v.isSet = true
