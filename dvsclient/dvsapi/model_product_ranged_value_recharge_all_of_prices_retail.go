...
// checks if the ProductRangedValueRechargeAllOfPricesRetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductRangedValueRechargeAllOfPricesRetail{}

// ProductRangedValueRechargeAllOfPricesRetail struct for ProductRangedValueRechargeAllOfPricesRetail
type ProductRangedValueRechargeAllOfPricesRetail struct {
...
func NewProductRangedValueRechargeAllOfPricesRetail(unitType UnitTypes, unit NullableString, amount RangeWithoutIncrement, fee NullableFloat32) *ProductRangedValueRechargeAllOfPricesRetail {
	this := ProductRangedValueRechargeAllOfPricesRetail{}
...
func (o ProductRangedValueRechargeAllOfPricesRetail) MarshalJSON() ([]byte, error) {
...
func (o ProductRangedValueRechargeAllOfPricesRetail) ToMap() (map[string]interface{}, error) {
...
type NullableProductRangedValueRechargeAllOfPricesRetail struct {
	value *ProductRangedValueRechargeAllOfPricesRetail
	isSet bool
}

func (v NullableProductRangedValueRechargeAllOfPricesRetail) Get() *ProductRangedValueRechargeAllOfPricesRetail {
	return v.value
}

func (v *NullableProductRangedValueRechargeAllOfPricesRetail) Set(val *ProductRangedValueRechargeAllOfPricesRetail) {
	v.value = val
	v.isSet = true
}

func (v NullableProductRangedValueRechargeAllOfPricesRetail) IsSet() bool {
	return v.isSet
}

func (v *NullableProductRangedValueRechargeAllOfPricesRetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductRangedValueRechargeAllOfPricesRetail(val *ProductRangedValueRechargeAllOfPricesRetail) *NullableProductRangedValueRechargeAllOfPricesRetail {
	return &NullableProductRangedValueRechargeAllOfPricesRetail{value: val, isSet: true}
}

func (v NullableProductRangedValueRechargeAllOfPricesRetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductRangedValueRechargeAllOfPricesRetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
