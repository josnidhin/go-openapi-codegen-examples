...
func NewLookupMobileNumberMobileNumberGet200ResponseInner(id int32, name string, country Country, regions []ServiceRegion, identified bool) *LookupMobileNumberMobileNumberGet200ResponseInner {
	this := LookupMobileNumberMobileNumberGet200ResponseInner{}
	this.Id = id
	this.Name = name
...
func (o LookupMobileNumberMobileNumberGet200ResponseInner) MarshalJSON() ([]byte, error) {
...
type NullableLookupMobileNumberMobileNumberGet200ResponseInner struct {
	value *LookupMobileNumberMobileNumberGet200ResponseInner
	isSet bool
}

func (v NullableLookupMobileNumberMobileNumberGet200ResponseInner) Get() *LookupMobileNumberMobileNumberGet200ResponseInner {
	return v.value
}

func (v *NullableLookupMobileNumberMobileNumberGet200ResponseInner) Set(val *LookupMobileNumberMobileNumberGet200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableLookupMobileNumberMobileNumberGet200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableLookupMobileNumberMobileNumberGet200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLookupMobileNumberMobileNumberGet200ResponseInner(val *LookupMobileNumberMobileNumberGet200ResponseInner) *NullableLookupMobileNumberMobileNumberGet200ResponseInner {
	return &NullableLookupMobileNumberMobileNumberGet200ResponseInner{value: val, isSet: true}
}

func (v NullableLookupMobileNumberMobileNumberGet200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLookupMobileNumberMobileNumberGet200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
