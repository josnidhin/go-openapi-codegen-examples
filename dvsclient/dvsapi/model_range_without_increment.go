...
// checks if the RangeWithoutIncrement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangeWithoutIncrement{}

// RangeWithoutIncrement struct for RangeWithoutIncrement
type RangeWithoutIncrement struct {
...
func (o RangeWithoutIncrement) MarshalJSON() ([]byte, error) {
...
func (o RangeWithoutIncrement) ToMap() (map[string]interface{}, error) {
...
type NullableRangeWithoutIncrement struct {
	value *RangeWithoutIncrement
	isSet bool
}

func (v NullableRangeWithoutIncrement) Get() *RangeWithoutIncrement {
	return v.value
}

func (v *NullableRangeWithoutIncrement) Set(val *RangeWithoutIncrement) {
	v.value = val
	v.isSet = true
}

func (v NullableRangeWithoutIncrement) IsSet() bool {
	return v.isSet
}

func (v *NullableRangeWithoutIncrement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangeWithoutIncrement(val *RangeWithoutIncrement) *NullableRangeWithoutIncrement {
	return &NullableRangeWithoutIncrement{value: val, isSet: true}
}

func (v NullableRangeWithoutIncrement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangeWithoutIncrement) UnmarshalJSON(src []byte) error {
	v.isSet = true
