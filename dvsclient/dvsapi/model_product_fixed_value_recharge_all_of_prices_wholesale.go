...
// checks if the ProductFixedValueRechargeAllOfPricesWholesale type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductFixedValueRechargeAllOfPricesWholesale{}
...
func NewProductFixedValueRechargeAllOfPricesWholesale(unitType UnitTypes, unit string, amount float32, fee float32) *ProductFixedValueRechargeAllOfPricesWholesale {
	this := ProductFixedValueRechargeAllOfPricesWholesale{}
...
func (o ProductFixedValueRechargeAllOfPricesWholesale) MarshalJSON() ([]byte, error) {
...
func (o ProductFixedValueRechargeAllOfPricesWholesale) ToMap() (map[string]interface{}, error) {
...
type NullableProductFixedValueRechargeAllOfPricesWholesale struct {
	value *ProductFixedValueRechargeAllOfPricesWholesale
	isSet bool
}

func (v NullableProductFixedValueRechargeAllOfPricesWholesale) Get() *ProductFixedValueRechargeAllOfPricesWholesale {
	return v.value
}

func (v *NullableProductFixedValueRechargeAllOfPricesWholesale) Set(val *ProductFixedValueRechargeAllOfPricesWholesale) {
	v.value = val
	v.isSet = true
}

func (v NullableProductFixedValueRechargeAllOfPricesWholesale) IsSet() bool {
	return v.isSet
}

func (v *NullableProductFixedValueRechargeAllOfPricesWholesale) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductFixedValueRechargeAllOfPricesWholesale(val *ProductFixedValueRechargeAllOfPricesWholesale) *NullableProductFixedValueRechargeAllOfPricesWholesale {
	return &NullableProductFixedValueRechargeAllOfPricesWholesale{value: val, isSet: true}
}

func (v NullableProductFixedValueRechargeAllOfPricesWholesale) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductFixedValueRechargeAllOfPricesWholesale) UnmarshalJSON(src []byte) error {
	v.isSet = true
