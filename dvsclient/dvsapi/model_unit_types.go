...
// UnitTypes the model 'UnitTypes'
type UnitTypes string

// List of UnitTypes
const (
	UNITTYPES_CURRENCY UnitTypes = "CURRENCY"
)

// All allowed values of UnitTypes enum
var AllowedUnitTypesEnumValues = []UnitTypes{
	"CURRENCY",
}

func (v *UnitTypes) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := UnitTypes(value)
	for _, existing := range AllowedUnitTypesEnumValues {
	...
	return fmt.Errorf("%+v is not a valid UnitTypes", value)
}

// NewUnitTypesFromValue returns a pointer to a valid UnitTypes
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewUnitTypesFromValue(v string) (*UnitTypes, error) {
	ev := UnitTypes(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for UnitTypes: valid values are %v", v, AllowedUnitTypesEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v UnitTypes) IsValid() bool {
	for _, existing := range AllowedUnitTypesEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to UnitTypes value
func (v UnitTypes) Ptr() *UnitTypes {
	return &v
}

type NullableUnitTypes struct {
	value *UnitTypes
	isSet bool
}

func (v NullableUnitTypes) Get() *UnitTypes {
	return v.value
}

func (v *NullableUnitTypes) Set(val *UnitTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableUnitTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableUnitTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnitTypes(val *UnitTypes) *NullableUnitTypes {
	return &NullableUnitTypes{value: val, isSet: true}
}

func (v NullableUnitTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnitTypes) UnmarshalJSON(src []byte) error {
	v.isSet = true
