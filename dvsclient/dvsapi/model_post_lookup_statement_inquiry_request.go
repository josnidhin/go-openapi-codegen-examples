...
// checks if the PostLookupStatementInquiryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostLookupStatementInquiryRequest{}
...
func (o PostLookupStatementInquiryRequest) ToMap() (map[string]interface{}, error) {
