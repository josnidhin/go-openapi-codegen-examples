...
// BenefitTypes the model 'BenefitTypes'
type BenefitTypes string
...
var AllowedBenefitTypesEnumValues = []BenefitTypes{
	"TALKTIME",
	"DATA",
	"SMS",
	"PAYMENT",
...
func (v *BenefitTypes) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := BenefitTypes(value)
	for _, existing := range AllowedBenefitTypesEnumValues {
	...
	return fmt.Errorf("%+v is not a valid BenefitTypes", value)
}

// NewBenefitTypesFromValue returns a pointer to a valid BenefitTypes
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewBenefitTypesFromValue(v string) (*BenefitTypes, error) {
	ev := BenefitTypes(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for BenefitTypes: valid values are %v", v, AllowedBenefitTypesEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v BenefitTypes) IsValid() bool {
	for _, existing := range AllowedBenefitTypesEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to BenefitTypes value
func (v BenefitTypes) Ptr() *BenefitTypes {
	return &v
}

type NullableBenefitTypes struct {
	value *BenefitTypes
	isSet bool
}

func (v NullableBenefitTypes) Get() *BenefitTypes {
	return v.value
}

func (v *NullableBenefitTypes) Set(val *BenefitTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableBenefitTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableBenefitTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBenefitTypes(val *BenefitTypes) *NullableBenefitTypes {
	return &NullableBenefitTypes{value: val, isSet: true}
}

func (v NullableBenefitTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBenefitTypes) UnmarshalJSON(src []byte) error {
	v.isSet = true
