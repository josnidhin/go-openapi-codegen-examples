...
// checks if the TransactionRequestedValues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionRequestedValues{}

// TransactionRequestedValues struct for TransactionRequestedValues
type TransactionRequestedValues struct {
	Source      *TransactionRequestedValuesSource `json:"source,omitempty"`
	Destination *TransactionRequestedValuesSource `json:"destination,omitempty"`
}
...
func NewTransactionRequestedValues() *TransactionRequestedValues {
	this := TransactionRequestedValues{}
	return &this
}
...
func (o *TransactionRequestedValues) GetSource() TransactionRequestedValuesSource {
	if o == nil || IsNil(o.Source) {
		var ret TransactionRequestedValuesSource
		return ret
	}
	return *o.Source
}
...
// SetSource gets a reference to the given TransactionRequestedValuesSource and assigns it to the Source field.
...
// SetDestination gets a reference to the given TransactionRequestedValuesSource and assigns it to the Destination field.
func (o *TransactionRequestedValues) SetDestination(v TransactionRequestedValuesSource) {
	o.Destination = &v
}

func (o TransactionRequestedValues) MarshalJSON() ([]byte, error) {
...
func (o TransactionRequestedValues) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionRequestedValues struct {
	value *TransactionRequestedValues
	isSet bool
}

func (v NullableTransactionRequestedValues) Get() *TransactionRequestedValues {
	return v.value
}

func (v *NullableTransactionRequestedValues) Set(val *TransactionRequestedValues) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionRequestedValues) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionRequestedValues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionRequestedValues(val *TransactionRequestedValues) *NullableTransactionRequestedValues {
	return &NullableTransactionRequestedValues{value: val, isSet: true}
}

func (v NullableTransactionRequestedValues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionRequestedValues) UnmarshalJSON(src []byte) error {
	v.isSet = true
