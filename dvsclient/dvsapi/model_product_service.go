...
// ProductService struct for ProductService
type ProductService struct {
	Id         int32                            `json:"id"`
	Name       string                           `json:"name"`
	Subservice NullableProductServiceSubservice `json:"subservice,omitempty"`
}
...
// GetSubservice returns the Subservice field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ProductService) GetSubservice() ProductServiceSubservice {
	if o == nil || IsNil(o.Subservice.Get()) {
		var ret ProductServiceSubservice
		return ret
	}
	return *o.Subservice.Get()
}
...
// SetSubservice gets a reference to the given NullableProductServiceSubservice and assigns it to the Subservice field.
...
func (o *ProductService) SetSubserviceNil() {
	o.Subservice.Set(nil)
}
...
func (o ProductService) ToMap() (map[string]interface{}, error) {
	...
	if o.Subservice.IsSet() {
		toSerialize["subservice"] = o.Subservice.Get()
	}
