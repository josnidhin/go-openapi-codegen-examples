...
// checks if the RangedBenefit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangedBenefit{}
...
func (o *RangedBenefit) GetAmount() RangeBenefitAmountWithoutIncrement {
	if o == nil {
		var ret RangeBenefitAmountWithoutIncrement
		return ret
	}
...
func (o *RangedBenefit) GetAdditionalInformation() string {
	if o == nil || o.AdditionalInformation.Get() == nil {
		var ret string
		return ret
	}
...
func (o RangedBenefit) MarshalJSON() ([]byte, error) {
...
func (o RangedBenefit) ToMap() (map[string]interface{}, error) {
...
type NullableRangedBenefit struct {
	value *RangedBenefit
	isSet bool
}

func (v NullableRangedBenefit) Get() *RangedBenefit {
	return v.value
}

func (v *NullableRangedBenefit) Set(val *RangedBenefit) {
	v.value = val
	v.isSet = true
}

func (v NullableRangedBenefit) IsSet() bool {
	return v.isSet
}

func (v *NullableRangedBenefit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangedBenefit(val *RangedBenefit) *NullableRangedBenefit {
	return &NullableRangedBenefit{value: val, isSet: true}
}

func (v NullableRangedBenefit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangedBenefit) UnmarshalJSON(src []byte) error {
	v.isSet = true
