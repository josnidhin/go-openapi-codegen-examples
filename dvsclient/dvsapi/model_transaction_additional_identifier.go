...
// checks if the TransactionAdditionalIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionAdditionalIdentifier{}

// TransactionAdditionalIdentifier struct for TransactionAdditionalIdentifier
type TransactionAdditionalIdentifier struct {
	// Anonymized ID related to the purchase for compliance reasons (e.g. terminal, POS, agent, end user, etc.)
...
func NewTransactionAdditionalIdentifier() *TransactionAdditionalIdentifier {
	this := TransactionAdditionalIdentifier{}
	return &this
}
...
// GetPurchaserId returns the PurchaserId field value if set, zero value otherwise.
func (o *TransactionAdditionalIdentifier) GetPurchaserId() string {
	if o == nil || IsNil(o.PurchaserId) {
		var ret string
		return ret
	}
...
// GetPurchaserIdOk returns a tuple with the PurchaserId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransactionAdditionalIdentifier) GetPurchaserIdOk() (*string, bool) {
	if o == nil || IsNil(o.PurchaserId) {
		return nil, false
	}
	return o.PurchaserId, true
}
...
// SetPurchaserId gets a reference to the given string and assigns it to the PurchaserId field.
func (o *TransactionAdditionalIdentifier) SetPurchaserId(v string) {
	o.PurchaserId = &v
}

func (o TransactionAdditionalIdentifier) MarshalJSON() ([]byte, error) {
...
func (o TransactionAdditionalIdentifier) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PurchaserId) {
		toSerialize["purchaser_id"] = o.PurchaserId
	}
	return toSerialize, nil
}

type NullableTransactionAdditionalIdentifier struct {
	value *TransactionAdditionalIdentifier
	isSet bool
}

func (v NullableTransactionAdditionalIdentifier) Get() *TransactionAdditionalIdentifier {
	return v.value
}

func (v *NullableTransactionAdditionalIdentifier) Set(val *TransactionAdditionalIdentifier) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionAdditionalIdentifier) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionAdditionalIdentifier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionAdditionalIdentifier(val *TransactionAdditionalIdentifier) *NullableTransactionAdditionalIdentifier {
	return &NullableTransactionAdditionalIdentifier{value: val, isSet: true}
}

func (v NullableTransactionAdditionalIdentifier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionAdditionalIdentifier) UnmarshalJSON(src []byte) error {
	v.isSet = true
