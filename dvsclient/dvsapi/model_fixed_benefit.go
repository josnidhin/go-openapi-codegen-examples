...
// checks if the FixedBenefit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FixedBenefit{}
...
func (o FixedBenefit) MarshalJSON() ([]byte, error) {
...
func (o FixedBenefit) ToMap() (map[string]interface{}, error) {
...
type NullableFixedBenefit struct {
	value *FixedBenefit
	isSet bool
}

func (v NullableFixedBenefit) Get() *FixedBenefit {
	return v.value
}

func (v *NullableFixedBenefit) Set(val *FixedBenefit) {
	v.value = val
	v.isSet = true
}

func (v NullableFixedBenefit) IsSet() bool {
	return v.isSet
}

func (v *NullableFixedBenefit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFixedBenefit(val *FixedBenefit) *NullableFixedBenefit {
	return &NullableFixedBenefit{value: val, isSet: true}
}

func (v NullableFixedBenefit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFixedBenefit) UnmarshalJSON(src []byte) error {
	v.isSet = true
