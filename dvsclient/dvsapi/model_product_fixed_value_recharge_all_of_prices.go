...
// checks if the ProductFixedValueRechargeAllOfPrices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductFixedValueRechargeAllOfPrices{}

// ProductFixedValueRechargeAllOfPrices struct for ProductFixedValueRechargeAllOfPrices
type ProductFixedValueRechargeAllOfPrices struct {
	Wholesale ProductFixedValueRechargeAllOfPricesWholesale      `json:"wholesale"`
	Retail    NullableProductFixedValueRechargeAllOfPricesRetail `json:"retail"`
}
...
func NewProductFixedValueRechargeAllOfPrices(wholesale ProductFixedValueRechargeAllOfPricesWholesale, retail NullableProductFixedValueRechargeAllOfPricesRetail) *ProductFixedValueRechargeAllOfPrices {
	this := ProductFixedValueRechargeAllOfPrices{}
...
func (o *ProductFixedValueRechargeAllOfPrices) GetWholesale() ProductFixedValueRechargeAllOfPricesWholesale {
	if o == nil {
		var ret ProductFixedValueRechargeAllOfPricesWholesale
		return ret
	}
...
// If the value is explicit nil, the zero value for ProductFixedValueRechargeAllOfPricesRetail will be returned
func (o *ProductFixedValueRechargeAllOfPrices) GetRetail() ProductFixedValueRechargeAllOfPricesRetail {
	if o == nil || o.Retail.Get() == nil {
		var ret ProductFixedValueRechargeAllOfPricesRetail
		return ret
	}
...
func (o ProductFixedValueRechargeAllOfPrices) MarshalJSON() ([]byte, error) {
...
func (o ProductFixedValueRechargeAllOfPrices) ToMap() (map[string]interface{}, error) {
...
type NullableProductFixedValueRechargeAllOfPrices struct {
	value *ProductFixedValueRechargeAllOfPrices
	isSet bool
}

func (v NullableProductFixedValueRechargeAllOfPrices) Get() *ProductFixedValueRechargeAllOfPrices {
	return v.value
}

func (v *NullableProductFixedValueRechargeAllOfPrices) Set(val *ProductFixedValueRechargeAllOfPrices) {
	v.value = val
	v.isSet = true
}

func (v NullableProductFixedValueRechargeAllOfPrices) IsSet() bool {
	return v.isSet
}

func (v *NullableProductFixedValueRechargeAllOfPrices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductFixedValueRechargeAllOfPrices(val *ProductFixedValueRechargeAllOfPrices) *NullableProductFixedValueRechargeAllOfPrices {
	return &NullableProductFixedValueRechargeAllOfPrices{value: val, isSet: true}
}

func (v NullableProductFixedValueRechargeAllOfPrices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductFixedValueRechargeAllOfPrices) UnmarshalJSON(src []byte) error {
	v.isSet = true
