...
// checks if the TransactionStatusClass type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionStatusClass{}
...
func (o TransactionStatusClass) MarshalJSON() ([]byte, error) {
...
func (o TransactionStatusClass) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionStatusClass struct {
	value *TransactionStatusClass
	isSet bool
}

func (v NullableTransactionStatusClass) Get() *TransactionStatusClass {
	return v.value
}

func (v *NullableTransactionStatusClass) Set(val *TransactionStatusClass) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionStatusClass) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionStatusClass) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionStatusClass(val *TransactionStatusClass) *NullableTransactionStatusClass {
	return &NullableTransactionStatusClass{value: val, isSet: true}
}

func (v NullableTransactionStatusClass) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionStatusClass) UnmarshalJSON(src []byte) error {
	v.isSet = true
