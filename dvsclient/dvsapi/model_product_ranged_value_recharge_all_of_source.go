...
// checks if the ProductRangedValueRechargeAllOfSource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductRangedValueRechargeAllOfSource{}

// ProductRangedValueRechargeAllOfSource struct for ProductRangedValueRechargeAllOfSource
type ProductRangedValueRechargeAllOfSource struct {
...
func NewProductRangedValueRechargeAllOfSource(unitType UnitTypes, unit string, amount RangeWithoutIncrement) *ProductRangedValueRechargeAllOfSource {
	this := ProductRangedValueRechargeAllOfSource{}
...
func (o ProductRangedValueRechargeAllOfSource) MarshalJSON() ([]byte, error) {
...
func (o ProductRangedValueRechargeAllOfSource) ToMap() (map[string]interface{}, error) {
...
type NullableProductRangedValueRechargeAllOfSource struct {
	value *ProductRangedValueRechargeAllOfSource
	isSet bool
}

func (v NullableProductRangedValueRechargeAllOfSource) Get() *ProductRangedValueRechargeAllOfSource {
	return v.value
}

func (v *NullableProductRangedValueRechargeAllOfSource) Set(val *ProductRangedValueRechargeAllOfSource) {
	v.value = val
	v.isSet = true
}

func (v NullableProductRangedValueRechargeAllOfSource) IsSet() bool {
	return v.isSet
}

func (v *NullableProductRangedValueRechargeAllOfSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductRangedValueRechargeAllOfSource(val *ProductRangedValueRechargeAllOfSource) *NullableProductRangedValueRechargeAllOfSource {
	return &NullableProductRangedValueRechargeAllOfSource{value: val, isSet: true}
}

func (v NullableProductRangedValueRechargeAllOfSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductRangedValueRechargeAllOfSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
