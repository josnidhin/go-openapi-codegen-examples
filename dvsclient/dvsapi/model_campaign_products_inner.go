...
// checks if the CampaignProductsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignProductsInner{}
...
func (o CampaignProductsInner) MarshalJSON() ([]byte, error) {
...
func (o CampaignProductsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignProductsInner struct {
	value *CampaignProductsInner
	isSet bool
}

func (v NullableCampaignProductsInner) Get() *CampaignProductsInner {
	return v.value
}

func (v *NullableCampaignProductsInner) Set(val *CampaignProductsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignProductsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignProductsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignProductsInner(val *CampaignProductsInner) *NullableCampaignProductsInner {
	return &NullableCampaignProductsInner{value: val, isSet: true}
}

func (v NullableCampaignProductsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignProductsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
