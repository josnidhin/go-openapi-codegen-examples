...
// checks if the PostTransactionAsyncRequestAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostTransactionAsyncRequestAllOf{}
...
func (o PostTransactionAsyncRequestAllOf) ToMap() (map[string]interface{}, error) {
