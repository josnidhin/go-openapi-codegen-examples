...
// checks if the ProductFixedValueRechargeAllOfValidity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductFixedValueRechargeAllOfValidity{}

// ProductFixedValueRechargeAllOfValidity struct for ProductFixedValueRechargeAllOfValidity
type ProductFixedValueRechargeAllOfValidity struct {
...
func NewProductFixedValueRechargeAllOfValidity(unit TimeUnits, quantity float32) *ProductFixedValueRechargeAllOfValidity {
	this := ProductFixedValueRechargeAllOfValidity{}
	this.Unit = unit
...
func (o ProductFixedValueRechargeAllOfValidity) MarshalJSON() ([]byte, error) {
...
func (o ProductFixedValueRechargeAllOfValidity) ToMap() (map[string]interface{}, error) {
...
type NullableProductFixedValueRechargeAllOfValidity struct {
	value *ProductFixedValueRechargeAllOfValidity
	isSet bool
}

func (v NullableProductFixedValueRechargeAllOfValidity) Get() *ProductFixedValueRechargeAllOfValidity {
	return v.value
}

func (v *NullableProductFixedValueRechargeAllOfValidity) Set(val *ProductFixedValueRechargeAllOfValidity) {
	v.value = val
	v.isSet = true
}

func (v NullableProductFixedValueRechargeAllOfValidity) IsSet() bool {
	return v.isSet
}

func (v *NullableProductFixedValueRechargeAllOfValidity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductFixedValueRechargeAllOfValidity(val *ProductFixedValueRechargeAllOfValidity) *NullableProductFixedValueRechargeAllOfValidity {
	return &NullableProductFixedValueRechargeAllOfValidity{value: val, isSet: true}
}

func (v NullableProductFixedValueRechargeAllOfValidity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductFixedValueRechargeAllOfValidity) UnmarshalJSON(src []byte) error {
	v.isSet = true
