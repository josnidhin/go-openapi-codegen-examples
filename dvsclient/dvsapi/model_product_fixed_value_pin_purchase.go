...
func NewProductFixedValuePinPurchase(id int32, name string, description string, tags []string, service Service, operator OperatorsGet200ResponseInner, regions []ServiceRegion, type_ string, validity NullableProductFixedValueRechargeAllOfValidity, requiredDebitPartyIdentifierFields [][]string, requiredCreditPartyIdentifierFields [][]string, requiredSenderFields [][]string, requiredBeneficiaryFields [][]string, requiredStatementIdentifierFields [][]string, availabilityZones []AvailabilityZones, source ProductFixedValueRechargeAllOfSource, destination ProductFixedValueRechargeAllOfSource, prices ProductFixedValueRechargeAllOfPrices, rates Rates, pin PIN, benefits []FixedBenefit, promotions []ProductPromotion) *ProductFixedValuePinPurchase {
	this := ProductFixedValuePinPurchase{}
	this.Id = id
	this.Name = name
...
func (o *ProductFixedValuePinPurchase) GetService() Service {
	if o == nil {
		var ret Service
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProductFixedValuePinPurchase) GetServiceOk() (*Service, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProductFixedValuePinPurchase) SetService(v Service) {
	o.Service = v
}

// GetOperator returns the Operator field value
func (o *ProductFixedValuePinPurchase) GetOperator() OperatorsGet200ResponseInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ProductFixedValuePinPurchase) GetOperatorOk() (*OperatorsGet200ResponseInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProductFixedValuePinPurchase) SetOperator(v OperatorsGet200ResponseInner) {
	o.Operator = v
}
...
func (o *ProductFixedValuePinPurchase) GetRequiredCreditPartyIdentifierFieldsOk() ([][]string, bool) {
	if o == nil || o.RequiredCreditPartyIdentifierFields == nil {
		return nil, false
	}
...
func (o ProductFixedValuePinPurchase) MarshalJSON() ([]byte, error) {
...
type NullableProductFixedValuePinPurchase struct {
	value *ProductFixedValuePinPurchase
	isSet bool
}

func (v NullableProductFixedValuePinPurchase) Get() *ProductFixedValuePinPurchase {
	return v.value
}

func (v *NullableProductFixedValuePinPurchase) Set(val *ProductFixedValuePinPurchase) {
	v.value = val
	v.isSet = true
}

func (v NullableProductFixedValuePinPurchase) IsSet() bool {
	return v.isSet
}

func (v *NullableProductFixedValuePinPurchase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductFixedValuePinPurchase(val *ProductFixedValuePinPurchase) *NullableProductFixedValuePinPurchase {
	return &NullableProductFixedValuePinPurchase{value: val, isSet: true}
}

func (v NullableProductFixedValuePinPurchase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductFixedValuePinPurchase) UnmarshalJSON(src []byte) error {
	v.isSet = true
