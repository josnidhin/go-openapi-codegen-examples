...
// checks if the ProductFixedValuePinPurchase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductFixedValuePinPurchase{}
...
func (o ProductFixedValuePinPurchase) ToMap() (map[string]interface{}, error) {
