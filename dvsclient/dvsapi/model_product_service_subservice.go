...
// checks if the ProductServiceSubservice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductServiceSubservice{}

// ProductServiceSubservice struct for ProductServiceSubservice
type ProductServiceSubservice struct {
...
func (o ProductServiceSubservice) MarshalJSON() ([]byte, error) {
...
func (o ProductServiceSubservice) ToMap() (map[string]interface{}, error) {
...
type NullableProductServiceSubservice struct {
	value *ProductServiceSubservice
	isSet bool
}

func (v NullableProductServiceSubservice) Get() *ProductServiceSubservice {
	return v.value
}

func (v *NullableProductServiceSubservice) Set(val *ProductServiceSubservice) {
	v.value = val
	v.isSet = true
}

func (v NullableProductServiceSubservice) IsSet() bool {
	return v.isSet
}

func (v *NullableProductServiceSubservice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductServiceSubservice(val *ProductServiceSubservice) *NullableProductServiceSubservice {
	return &NullableProductServiceSubservice{value: val, isSet: true}
}

func (v NullableProductServiceSubservice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductServiceSubservice) UnmarshalJSON(src []byte) error {
	v.isSet = true
