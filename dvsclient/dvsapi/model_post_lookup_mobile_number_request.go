...
// checks if the PostLookupMobileNumberRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostLookupMobileNumberRequest{}
...
func (o PostLookupMobileNumberRequest) ToMap() (map[string]interface{}, error) {
