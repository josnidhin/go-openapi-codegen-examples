...
// checks if the TransactionCreditPartyIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionCreditPartyIdentifier{}
...
func NewTransactionCreditPartyIdentifier() *TransactionCreditPartyIdentifier {
	this := TransactionCreditPartyIdentifier{}
	return &this
}
...
func (o TransactionCreditPartyIdentifier) MarshalJSON() ([]byte, error) {
...
func (o TransactionCreditPartyIdentifier) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionCreditPartyIdentifier struct {
	value *TransactionCreditPartyIdentifier
	isSet bool
}

func (v NullableTransactionCreditPartyIdentifier) Get() *TransactionCreditPartyIdentifier {
	return v.value
}

func (v *NullableTransactionCreditPartyIdentifier) Set(val *TransactionCreditPartyIdentifier) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionCreditPartyIdentifier) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionCreditPartyIdentifier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionCreditPartyIdentifier(val *TransactionCreditPartyIdentifier) *NullableTransactionCreditPartyIdentifier {
	return &NullableTransactionCreditPartyIdentifier{value: val, isSet: true}
}

func (v NullableTransactionCreditPartyIdentifier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionCreditPartyIdentifier) UnmarshalJSON(src []byte) error {
	v.isSet = true
