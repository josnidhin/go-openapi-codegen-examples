...
func Test_dvsapi_ProductsApiService(t *testing.T) {

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)

	t.Run("Test ProductsApiService GetProductById", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var productId int32

		resp, httpRes, err := apiClient.ProductsApi.GetProductById(context.Background(), productId).Execute()
