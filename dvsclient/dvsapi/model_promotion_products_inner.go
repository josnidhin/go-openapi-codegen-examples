...
// checks if the PromotionProductsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionProductsInner{}
...
func (o PromotionProductsInner) MarshalJSON() ([]byte, error) {
...
func (o PromotionProductsInner) ToMap() (map[string]interface{}, error) {
...
type NullablePromotionProductsInner struct {
	value *PromotionProductsInner
	isSet bool
}

func (v NullablePromotionProductsInner) Get() *PromotionProductsInner {
	return v.value
}

func (v *NullablePromotionProductsInner) Set(val *PromotionProductsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionProductsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionProductsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotionProductsInner(val *PromotionProductsInner) *NullablePromotionProductsInner {
	return &NullablePromotionProductsInner{value: val, isSet: true}
}

func (v NullablePromotionProductsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotionProductsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
