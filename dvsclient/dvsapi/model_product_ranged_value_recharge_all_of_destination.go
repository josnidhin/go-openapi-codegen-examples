...
// checks if the ProductRangedValueRechargeAllOfDestination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductRangedValueRechargeAllOfDestination{}

// ProductRangedValueRechargeAllOfDestination struct for ProductRangedValueRechargeAllOfDestination
type ProductRangedValueRechargeAllOfDestination struct {
...
func NewProductRangedValueRechargeAllOfDestination(unitType UnitTypes, unit string, amount Range) *ProductRangedValueRechargeAllOfDestination {
	this := ProductRangedValueRechargeAllOfDestination{}
...
func (o ProductRangedValueRechargeAllOfDestination) MarshalJSON() ([]byte, error) {
...
func (o ProductRangedValueRechargeAllOfDestination) ToMap() (map[string]interface{}, error) {
...
type NullableProductRangedValueRechargeAllOfDestination struct {
	value *ProductRangedValueRechargeAllOfDestination
	isSet bool
}

func (v NullableProductRangedValueRechargeAllOfDestination) Get() *ProductRangedValueRechargeAllOfDestination {
	return v.value
}

func (v *NullableProductRangedValueRechargeAllOfDestination) Set(val *ProductRangedValueRechargeAllOfDestination) {
	v.value = val
	v.isSet = true
}

func (v NullableProductRangedValueRechargeAllOfDestination) IsSet() bool {
	return v.isSet
}

func (v *NullableProductRangedValueRechargeAllOfDestination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductRangedValueRechargeAllOfDestination(val *ProductRangedValueRechargeAllOfDestination) *NullableProductRangedValueRechargeAllOfDestination {
	return &NullableProductRangedValueRechargeAllOfDestination{value: val, isSet: true}
}

func (v NullableProductRangedValueRechargeAllOfDestination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductRangedValueRechargeAllOfDestination) UnmarshalJSON(src []byte) error {
	v.isSet = true
