...
// checks if the PINValidity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PINValidity{}

// PINValidity struct for PINValidity
type PINValidity struct {
...
func (o PINValidity) MarshalJSON() ([]byte, error) {
...
func (o PINValidity) ToMap() (map[string]interface{}, error) {
...
type NullablePINValidity struct {
	value *PINValidity
	isSet bool
}

func (v NullablePINValidity) Get() *PINValidity {
	return v.value
}

func (v *NullablePINValidity) Set(val *PINValidity) {
	v.value = val
	v.isSet = true
}

func (v NullablePINValidity) IsSet() bool {
	return v.isSet
}

func (v *NullablePINValidity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePINValidity(val *PINValidity) *NullablePINValidity {
	return &NullablePINValidity{value: val, isSet: true}
}

func (v NullablePINValidity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePINValidity) UnmarshalJSON(src []byte) error {
	v.isSet = true
