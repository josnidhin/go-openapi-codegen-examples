...
func NewPayment(modes []PaymentModes, postingPeriod NullablePaymentPostingPeriod, supportsStatementInquiry bool) *Payment {
	...
	this.SupportsStatementInquiry = supportsStatementInquiry
	return &this
}
...
// If the value is explicit nil, the zero value for []PaymentModes will be returned
func (o *Payment) GetModes() []PaymentModes {
	if o == nil {
		var ret []PaymentModes
		return ret
	}
...
// GetPostingPeriod returns the PostingPeriod field value
// If the value is explicit nil, the zero value for PaymentPostingPeriod will be returned
func (o *Payment) GetPostingPeriod() PaymentPostingPeriod {
	if o == nil || o.PostingPeriod.Get() == nil {
		var ret PaymentPostingPeriod
		return ret
	}

	return *o.PostingPeriod.Get()
}

// GetPostingPeriodOk returns a tuple with the PostingPeriod field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Payment) GetPostingPeriodOk() (*PaymentPostingPeriod, bool) {
	...
	return o.PostingPeriod.Get(), o.PostingPeriod.IsSet()
}

// SetPostingPeriod sets field value
func (o *Payment) SetPostingPeriod(v PaymentPostingPeriod) {
	o.PostingPeriod.Set(&v)
}

// GetSupportsStatementInquiry returns the SupportsStatementInquiry field value
func (o *Payment) GetSupportsStatementInquiry() bool {
	...
	return o.SupportsStatementInquiry
}

// GetSupportsStatementInquiryOk returns a tuple with the SupportsStatementInquiry field value
// and a boolean to check if the value has been set.
func (o *Payment) GetSupportsStatementInquiryOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SupportsStatementInquiry, true
}

// SetSupportsStatementInquiry sets field value
func (o *Payment) SetSupportsStatementInquiry(v bool) {
	o.SupportsStatementInquiry = v
}

// GetRequiredInquiryFields returns the RequiredInquiryFields field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Payment) GetRequiredInquiryFields() [][]string {
	if o == nil {
		var ret [][]string
		return ret
	}
	return o.RequiredInquiryFields
}

// GetRequiredInquiryFieldsOk returns a tuple with the RequiredInquiryFields field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Payment) GetRequiredInquiryFieldsOk() ([][]string, bool) {
	if o == nil || IsNil(o.RequiredInquiryFields) {
		return nil, false
	}
	return o.RequiredInquiryFields, true
}
...
// SetRequiredInquiryFields gets a reference to the given [][]string and assigns it to the RequiredInquiryFields field.
func (o *Payment) SetRequiredInquiryFields(v [][]string) {
	o.RequiredInquiryFields = v
}
...
func (o Payment) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["posting_period"] = o.PostingPeriod.Get()
	toSerialize["supports_statement_inquiry"] = o.SupportsStatementInquiry
	if o.RequiredInquiryFields != nil {
		toSerialize["required_inquiry_fields"] = o.RequiredInquiryFields
	}
	if o.Notes != nil {
