...
// checks if the ProductRangedValuePaymentAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductRangedValuePaymentAllOf{}

// ProductRangedValuePaymentAllOf struct for ProductRangedValuePaymentAllOf
type ProductRangedValuePaymentAllOf struct {
...
func NewProductRangedValuePaymentAllOf(type_ string, validity NullableProductFixedValueRechargeAllOfValidity, requiredDebitPartyIdentifierFields [][]string, requiredCreditPartyIdentifierFields [][]string, requiredSenderFields [][]string, requiredBeneficiaryFields [][]string, requiredStatementIdentifierFields [][]string, requiredAdditionalIdentifierFields [][]string, acceptedCalculationModes []CalculationModes, availabilityZones []AvailabilityZones, source ProductRangedValueRechargeAllOfSource, destination ProductRangedValueRechargeAllOfDestination, prices ProductRangedValueRechargeAllOfPrices, rates Rates, payment Payment, benefits []RangedBenefit, promotions []ProductPromotion) *ProductRangedValuePaymentAllOf {
	this := ProductRangedValuePaymentAllOf{}
	this.Type = type_
...
// If the value is explicit nil, the zero value for [][]string will be returned
func (o *ProductRangedValuePaymentAllOf) GetRequiredAdditionalIdentifierFields() [][]string {
	if o == nil {
		var ret [][]string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ProductRangedValuePaymentAllOf) GetRequiredAdditionalIdentifierFieldsOk() ([][]string, bool) {
...
func (o *ProductRangedValuePaymentAllOf) SetRequiredAdditionalIdentifierFields(v [][]string) {
...
func (o ProductRangedValuePaymentAllOf) MarshalJSON() ([]byte, error) {
...
func (o ProductRangedValuePaymentAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableProductRangedValuePaymentAllOf struct {
	value *ProductRangedValuePaymentAllOf
	isSet bool
}

func (v NullableProductRangedValuePaymentAllOf) Get() *ProductRangedValuePaymentAllOf {
	return v.value
}

func (v *NullableProductRangedValuePaymentAllOf) Set(val *ProductRangedValuePaymentAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableProductRangedValuePaymentAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableProductRangedValuePaymentAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductRangedValuePaymentAllOf(val *ProductRangedValuePaymentAllOf) *NullableProductRangedValuePaymentAllOf {
	return &NullableProductRangedValuePaymentAllOf{value: val, isSet: true}
}

func (v NullableProductRangedValuePaymentAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductRangedValuePaymentAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
