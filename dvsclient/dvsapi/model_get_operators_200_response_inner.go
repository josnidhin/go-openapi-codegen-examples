...
// checks if the GetOperators200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOperators200ResponseInner{}

// GetOperators200ResponseInner struct for GetOperators200ResponseInner
type GetOperators200ResponseInner struct {
	Id      int32           `json:"id"`
...
func NewGetOperators200ResponseInner(id int32, name string, country Country, regions []ServiceRegion) *GetOperators200ResponseInner {
	this := GetOperators200ResponseInner{}
	this.Id = id
	this.Name = name
...
func (o GetOperators200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o GetOperators200ResponseInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetOperators200ResponseInner struct {
	value *GetOperators200ResponseInner
	isSet bool
}

func (v NullableGetOperators200ResponseInner) Get() *GetOperators200ResponseInner {
	return v.value
}

func (v *NullableGetOperators200ResponseInner) Set(val *GetOperators200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOperators200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOperators200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOperators200ResponseInner(val *GetOperators200ResponseInner) *NullableGetOperators200ResponseInner {
	return &NullableGetOperators200ResponseInner{value: val, isSet: true}
}

func (v NullableGetOperators200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOperators200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
