...
// BenefitUnitTypes the model 'BenefitUnitTypes'
type BenefitUnitTypes string
...
// All allowed values of BenefitUnitTypes enum
var AllowedBenefitUnitTypesEnumValues = []BenefitUnitTypes{
	"TIME",
	"DATA",
	"QUANTITY",
	"CURRENCY",
...
func (v *BenefitUnitTypes) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := BenefitUnitTypes(value)
	for _, existing := range AllowedBenefitUnitTypesEnumValues {
	...
	return fmt.Errorf("%+v is not a valid BenefitUnitTypes", value)
}

// NewBenefitUnitTypesFromValue returns a pointer to a valid BenefitUnitTypes
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewBenefitUnitTypesFromValue(v string) (*BenefitUnitTypes, error) {
	ev := BenefitUnitTypes(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for BenefitUnitTypes: valid values are %v", v, AllowedBenefitUnitTypesEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v BenefitUnitTypes) IsValid() bool {
	for _, existing := range AllowedBenefitUnitTypesEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to BenefitUnitTypes value
func (v BenefitUnitTypes) Ptr() *BenefitUnitTypes {
	return &v
}

type NullableBenefitUnitTypes struct {
	value *BenefitUnitTypes
	isSet bool
}

func (v NullableBenefitUnitTypes) Get() *BenefitUnitTypes {
	return v.value
}

func (v *NullableBenefitUnitTypes) Set(val *BenefitUnitTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableBenefitUnitTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableBenefitUnitTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBenefitUnitTypes(val *BenefitUnitTypes) *NullableBenefitUnitTypes {
	return &NullableBenefitUnitTypes{value: val, isSet: true}
}

func (v NullableBenefitUnitTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBenefitUnitTypes) UnmarshalJSON(src []byte) error {
	v.isSet = true
