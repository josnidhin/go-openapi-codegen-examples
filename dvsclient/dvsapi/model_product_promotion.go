...
// checks if the ProductPromotion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductPromotion{}

// ProductPromotion struct for ProductPromotion
...
func (o ProductPromotion) MarshalJSON() ([]byte, error) {
...
func (o ProductPromotion) ToMap() (map[string]interface{}, error) {
...
type NullableProductPromotion struct {
	value *ProductPromotion
	isSet bool
}

func (v NullableProductPromotion) Get() *ProductPromotion {
	return v.value
}

func (v *NullableProductPromotion) Set(val *ProductPromotion) {
	v.value = val
	v.isSet = true
}

func (v NullableProductPromotion) IsSet() bool {
	return v.isSet
}

func (v *NullableProductPromotion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductPromotion(val *ProductPromotion) *NullableProductPromotion {
	return &NullableProductPromotion{value: val, isSet: true}
}

func (v NullableProductPromotion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductPromotion) UnmarshalJSON(src []byte) error {
	v.isSet = true
