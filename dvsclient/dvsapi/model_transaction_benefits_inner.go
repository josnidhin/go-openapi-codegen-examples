...
// FixedBenefitAsTransactionBenefitsInner is a convenience function that returns FixedBenefit wrapped in TransactionBenefitsInner
func FixedBenefitAsTransactionBenefitsInner(v *FixedBenefit) TransactionBenefitsInner {
	return TransactionBenefitsInner{
		FixedBenefit: v,
	}
}

// RangedBenefitAsTransactionBenefitsInner is a convenience function that returns RangedBenefit wrapped in TransactionBenefitsInner
func RangedBenefitAsTransactionBenefitsInner(v *RangedBenefit) TransactionBenefitsInner {
	return TransactionBenefitsInner{
		RangedBenefit: v,
	}
}
...
func (dst *TransactionBenefitsInner) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into FixedBenefit
	err = newStrictDecoder(data).Decode(&dst.FixedBenefit)
	if err == nil {
		jsonFixedBenefit, _ := json.Marshal(dst.FixedBenefit)
		if string(jsonFixedBenefit) == "{}" { // empty struct
			dst.FixedBenefit = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into RangedBenefit
	err = newStrictDecoder(data).Decode(&dst.RangedBenefit)
	if err == nil {
		jsonRangedBenefit, _ := json.Marshal(dst.RangedBenefit)
		if string(jsonRangedBenefit) == "{}" { // empty struct
			dst.RangedBenefit = nil
		} else {
			match++
		}
	} else {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(TransactionBenefitsInner)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(TransactionBenefitsInner)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src TransactionBenefitsInner) MarshalJSON() ([]byte, error) {
	if src.FixedBenefit != nil {
		return json.Marshal(&src.FixedBenefit)
	}

	if src.RangedBenefit != nil {
		return json.Marshal(&src.RangedBenefit)
	}
...
func (obj *TransactionBenefitsInner) GetActualInstance() interface{} {
	...
	if obj.FixedBenefit != nil {
		return obj.FixedBenefit
	}

	if obj.RangedBenefit != nil {
		return obj.RangedBenefit
	}
...
type NullableTransactionBenefitsInner struct {
	value *TransactionBenefitsInner
	isSet bool
}

func (v NullableTransactionBenefitsInner) Get() *TransactionBenefitsInner {
	return v.value
}

func (v *NullableTransactionBenefitsInner) Set(val *TransactionBenefitsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionBenefitsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionBenefitsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionBenefitsInner(val *TransactionBenefitsInner) *NullableTransactionBenefitsInner {
	return &NullableTransactionBenefitsInner{value: val, isSet: true}
}

func (v NullableTransactionBenefitsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionBenefitsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
