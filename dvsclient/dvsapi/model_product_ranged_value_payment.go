...
// checks if the ProductRangedValuePayment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductRangedValuePayment{}

// ProductRangedValuePayment struct for ProductRangedValuePayment
type ProductRangedValuePayment struct {
	Id                                  int32                                          `json:"id"`
...
func NewProductRangedValuePayment(id int32, name string, description string, tags []string, service ProductService, operator GetOperators200ResponseInner, regions []ServiceRegion, type_ string, validity NullableProductFixedValueRechargeAllOfValidity, requiredDebitPartyIdentifierFields [][]string, requiredCreditPartyIdentifierFields [][]string, requiredSenderFields [][]string, requiredBeneficiaryFields [][]string, requiredStatementIdentifierFields [][]string, requiredAdditionalIdentifierFields [][]string, acceptedCalculationModes []CalculationModes, availabilityZones []AvailabilityZones, source ProductRangedValueRechargeAllOfSource, destination ProductRangedValueRechargeAllOfDestination, prices ProductRangedValueRechargeAllOfPrices, rates Rates, payment Payment, benefits []RangedBenefit, promotions []ProductPromotion) *ProductRangedValuePayment {
	this := ProductRangedValuePayment{}
	this.Id = id
	this.Name = name
...
func (o ProductRangedValuePayment) MarshalJSON() ([]byte, error) {
...
func (o ProductRangedValuePayment) ToMap() (map[string]interface{}, error) {
...
type NullableProductRangedValuePayment struct {
	value *ProductRangedValuePayment
	isSet bool
}

func (v NullableProductRangedValuePayment) Get() *ProductRangedValuePayment {
	return v.value
}

func (v *NullableProductRangedValuePayment) Set(val *ProductRangedValuePayment) {
	v.value = val
	v.isSet = true
}

func (v NullableProductRangedValuePayment) IsSet() bool {
	return v.isSet
}

func (v *NullableProductRangedValuePayment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductRangedValuePayment(val *ProductRangedValuePayment) *NullableProductRangedValuePayment {
	return &NullableProductRangedValuePayment{value: val, isSet: true}
}

func (v NullableProductRangedValuePayment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductRangedValuePayment) UnmarshalJSON(src []byte) error {
	v.isSet = true
