...
// checks if the RangeBenefitAmountWithoutIncrement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangeBenefitAmountWithoutIncrement{}
...
func NewRangeBenefitAmountWithoutIncrement(base RangeBenefitAmountWithoutIncrementBase, promotionBonus RangeBenefitAmountWithoutIncrementPromotionBonus, totalExcludingTax RangeBenefitAmountWithoutIncrementBase, totalIncludingTax RangeBenefitAmountWithoutIncrementBase) *RangeBenefitAmountWithoutIncrement {
	this := RangeBenefitAmountWithoutIncrement{}
	this.Base = base
...
func (o *RangeBenefitAmountWithoutIncrement) GetBase() RangeBenefitAmountWithoutIncrementBase {
	if o == nil {
		var ret RangeBenefitAmountWithoutIncrementBase
		return ret
	}
...
func (o *RangeBenefitAmountWithoutIncrement) GetTotalExcludingTax() RangeBenefitAmountWithoutIncrementBase {
	...
	return o.TotalExcludingTax
}

// GetTotalExcludingTaxOk returns a tuple with the TotalExcludingTax field value
// and a boolean to check if the value has been set.
func (o *RangeBenefitAmountWithoutIncrement) GetTotalExcludingTaxOk() (*RangeBenefitAmountWithoutIncrementBase, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TotalExcludingTax, true
}

// SetTotalExcludingTax sets field value
func (o *RangeBenefitAmountWithoutIncrement) SetTotalExcludingTax(v RangeBenefitAmountWithoutIncrementBase) {
	o.TotalExcludingTax = v
}

// GetTotalIncludingTax returns the TotalIncludingTax field value
func (o *RangeBenefitAmountWithoutIncrement) GetTotalIncludingTax() RangeBenefitAmountWithoutIncrementBase {
	...
	return o.TotalIncludingTax
}

// GetTotalIncludingTaxOk returns a tuple with the TotalIncludingTax field value
// and a boolean to check if the value has been set.
func (o *RangeBenefitAmountWithoutIncrement) GetTotalIncludingTaxOk() (*RangeBenefitAmountWithoutIncrementBase, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TotalIncludingTax, true
}

// SetTotalIncludingTax sets field value
func (o *RangeBenefitAmountWithoutIncrement) SetTotalIncludingTax(v RangeBenefitAmountWithoutIncrementBase) {
	o.TotalIncludingTax = v
}

func (o RangeBenefitAmountWithoutIncrement) MarshalJSON() ([]byte, error) {
...
func (o RangeBenefitAmountWithoutIncrement) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["base"] = o.Base
	toSerialize["promotion_bonus"] = o.PromotionBonus
	toSerialize["total_excluding_tax"] = o.TotalExcludingTax
	toSerialize["total_including_tax"] = o.TotalIncludingTax
	return toSerialize, nil
}

type NullableRangeBenefitAmountWithoutIncrement struct {
	value *RangeBenefitAmountWithoutIncrement
	isSet bool
}

func (v NullableRangeBenefitAmountWithoutIncrement) Get() *RangeBenefitAmountWithoutIncrement {
	return v.value
}

func (v *NullableRangeBenefitAmountWithoutIncrement) Set(val *RangeBenefitAmountWithoutIncrement) {
	v.value = val
	v.isSet = true
}

func (v NullableRangeBenefitAmountWithoutIncrement) IsSet() bool {
	return v.isSet
}

func (v *NullableRangeBenefitAmountWithoutIncrement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangeBenefitAmountWithoutIncrement(val *RangeBenefitAmountWithoutIncrement) *NullableRangeBenefitAmountWithoutIncrement {
	return &NullableRangeBenefitAmountWithoutIncrement{value: val, isSet: true}
}

func (v NullableRangeBenefitAmountWithoutIncrement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangeBenefitAmountWithoutIncrement) UnmarshalJSON(src []byte) error {
	v.isSet = true
