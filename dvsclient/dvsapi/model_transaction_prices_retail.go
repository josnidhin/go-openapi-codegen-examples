...
// checks if the TransactionPricesRetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionPricesRetail{}
...
func (o TransactionPricesRetail) MarshalJSON() ([]byte, error) {
...
func (o TransactionPricesRetail) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionPricesRetail struct {
	value *TransactionPricesRetail
	isSet bool
}

func (v NullableTransactionPricesRetail) Get() *TransactionPricesRetail {
	return v.value
}

func (v *NullableTransactionPricesRetail) Set(val *TransactionPricesRetail) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionPricesRetail) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionPricesRetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionPricesRetail(val *TransactionPricesRetail) *NullableTransactionPricesRetail {
	return &NullableTransactionPricesRetail{value: val, isSet: true}
}

func (v NullableTransactionPricesRetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionPricesRetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
