...
// checks if the ProductFixedValueRechargeAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductFixedValueRechargeAllOf{}
...
func NewProductFixedValueRechargeAllOf(type_ string, validity NullableProductFixedValueRechargeAllOfValidity, requiredDebitPartyIdentifierFields [][]string, requiredCreditPartyIdentifierFields [][]string, requiredSenderFields [][]string, requiredBeneficiaryFields [][]string, requiredStatementIdentifierFields [][]string, requiredAdditionalIdentifierFields [][]string, availabilityZones []AvailabilityZones, source ProductFixedValueRechargeAllOfSource, destination ProductFixedValueRechargeAllOfSource, prices ProductFixedValueRechargeAllOfPrices, rates Rates, benefits []FixedBenefit, promotions []ProductPromotion) *ProductFixedValueRechargeAllOf {
	this := ProductFixedValueRechargeAllOf{}
	this.Type = type_
...
func (o *ProductFixedValueRechargeAllOf) SetRequiredAdditionalIdentifierFields(v [][]string) {
...
func (o ProductFixedValueRechargeAllOf) MarshalJSON() ([]byte, error) {
...
func (o ProductFixedValueRechargeAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableProductFixedValueRechargeAllOf struct {
	value *ProductFixedValueRechargeAllOf
	isSet bool
}

func (v NullableProductFixedValueRechargeAllOf) Get() *ProductFixedValueRechargeAllOf {
	return v.value
}

func (v *NullableProductFixedValueRechargeAllOf) Set(val *ProductFixedValueRechargeAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableProductFixedValueRechargeAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableProductFixedValueRechargeAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductFixedValueRechargeAllOf(val *ProductFixedValueRechargeAllOf) *NullableProductFixedValueRechargeAllOf {
	return &NullableProductFixedValueRechargeAllOf{value: val, isSet: true}
}

func (v NullableProductFixedValueRechargeAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductFixedValueRechargeAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
