...
// checks if the TransactionRates type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionRates{}

// TransactionRates struct for TransactionRates
type TransactionRates struct {
...
func (o TransactionRates) MarshalJSON() ([]byte, error) {
...
func (o TransactionRates) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionRates struct {
	value *TransactionRates
	isSet bool
}

func (v NullableTransactionRates) Get() *TransactionRates {
	return v.value
}

func (v *NullableTransactionRates) Set(val *TransactionRates) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionRates) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionRates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionRates(val *TransactionRates) *NullableTransactionRates {
	return &NullableTransactionRates{value: val, isSet: true}
}

func (v NullableTransactionRates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionRates) UnmarshalJSON(src []byte) error {
	v.isSet = true
