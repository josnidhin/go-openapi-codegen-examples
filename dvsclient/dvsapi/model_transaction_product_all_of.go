...
// checks if the TransactionProductAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionProductAllOf{}

// TransactionProductAllOf struct for TransactionProductAllOf
type TransactionProductAllOf struct {
...
func (o TransactionProductAllOf) MarshalJSON() ([]byte, error) {
...
func (o TransactionProductAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionProductAllOf struct {
	value *TransactionProductAllOf
	isSet bool
}

func (v NullableTransactionProductAllOf) Get() *TransactionProductAllOf {
	return v.value
}

func (v *NullableTransactionProductAllOf) Set(val *TransactionProductAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionProductAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionProductAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionProductAllOf(val *TransactionProductAllOf) *NullableTransactionProductAllOf {
	return &NullableTransactionProductAllOf{value: val, isSet: true}
}

func (v NullableTransactionProductAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionProductAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
