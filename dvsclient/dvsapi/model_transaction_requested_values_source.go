...
// checks if the TransactionRequestedValuesSource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionRequestedValuesSource{}
...
func NewTransactionRequestedValuesSource(unitType UnitTypes, unit string, amount float32) *TransactionRequestedValuesSource {
	this := TransactionRequestedValuesSource{}
...
func (o TransactionRequestedValuesSource) MarshalJSON() ([]byte, error) {
...
func (o TransactionRequestedValuesSource) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionRequestedValuesSource struct {
	value *TransactionRequestedValuesSource
	isSet bool
}

func (v NullableTransactionRequestedValuesSource) Get() *TransactionRequestedValuesSource {
	return v.value
}

func (v *NullableTransactionRequestedValuesSource) Set(val *TransactionRequestedValuesSource) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionRequestedValuesSource) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionRequestedValuesSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionRequestedValuesSource(val *TransactionRequestedValuesSource) *NullableTransactionRequestedValuesSource {
	return &NullableTransactionRequestedValuesSource{value: val, isSet: true}
}

func (v NullableTransactionRequestedValuesSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionRequestedValuesSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
