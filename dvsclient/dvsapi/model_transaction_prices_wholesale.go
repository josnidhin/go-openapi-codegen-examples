...
// checks if the TransactionPricesWholesale type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionPricesWholesale{}

// TransactionPricesWholesale struct for TransactionPricesWholesale
type TransactionPricesWholesale struct {
...
func NewTransactionPricesWholesale(unitType UnitTypes, unit string, amount float32, fee float32) *TransactionPricesWholesale {
	this := TransactionPricesWholesale{}
...
func (o TransactionPricesWholesale) MarshalJSON() ([]byte, error) {
...
func (o TransactionPricesWholesale) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionPricesWholesale struct {
	value *TransactionPricesWholesale
	isSet bool
}

func (v NullableTransactionPricesWholesale) Get() *TransactionPricesWholesale {
	return v.value
}

func (v *NullableTransactionPricesWholesale) Set(val *TransactionPricesWholesale) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionPricesWholesale) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionPricesWholesale) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionPricesWholesale(val *TransactionPricesWholesale) *NullableTransactionPricesWholesale {
	return &NullableTransactionPricesWholesale{value: val, isSet: true}
}

func (v NullableTransactionPricesWholesale) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionPricesWholesale) UnmarshalJSON(src []byte) error {
	v.isSet = true
