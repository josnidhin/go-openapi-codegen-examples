...
// checks if the ProductRangedValueRechargeAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductRangedValueRechargeAllOf{}
...
func NewProductRangedValueRechargeAllOf(type_ string, validity NullableProductFixedValueRechargeAllOfValidity, requiredDebitPartyIdentifierFields [][]string, requiredCreditPartyIdentifierFields [][]string, requiredSenderFields [][]string, requiredBeneficiaryFields [][]string, requiredStatementIdentifierFields [][]string, requiredAdditionalIdentifierFields [][]string, acceptedCalculationModes []CalculationModes, availabilityZones []AvailabilityZones, source ProductRangedValueRechargeAllOfSource, destination ProductRangedValueRechargeAllOfDestination, prices ProductRangedValueRechargeAllOfPrices, rates Rates, benefits []RangedBenefit, promotions []ProductPromotion) *ProductRangedValueRechargeAllOf {
	this := ProductRangedValueRechargeAllOf{}
	this.Type = type_
...
func (o ProductRangedValueRechargeAllOf) MarshalJSON() ([]byte, error) {
...
func (o ProductRangedValueRechargeAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableProductRangedValueRechargeAllOf struct {
	value *ProductRangedValueRechargeAllOf
	isSet bool
}

func (v NullableProductRangedValueRechargeAllOf) Get() *ProductRangedValueRechargeAllOf {
	return v.value
}

func (v *NullableProductRangedValueRechargeAllOf) Set(val *ProductRangedValueRechargeAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableProductRangedValueRechargeAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableProductRangedValueRechargeAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductRangedValueRechargeAllOf(val *ProductRangedValueRechargeAllOf) *NullableProductRangedValueRechargeAllOf {
	return &NullableProductRangedValueRechargeAllOf{value: val, isSet: true}
}

func (v NullableProductRangedValueRechargeAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductRangedValueRechargeAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
