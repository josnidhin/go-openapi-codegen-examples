...
// ProductTypes the model 'ProductTypes'
type ProductTypes string

// List of ProductTypes
const (
	PRODUCTTYPES_FIXED_VALUE_RECHARGE      ProductTypes = "FIXED_VALUE_RECHARGE"
	PRODUCTTYPES_RANGED_VALUE_RECHARGE     ProductTypes = "RANGED_VALUE_RECHARGE"
	PRODUCTTYPES_FIXED_VALUE_PIN_PURCHASE  ProductTypes = "FIXED_VALUE_PIN_PURCHASE"
	PRODUCTTYPES_RANGED_VALUE_PIN_PURCHASE ProductTypes = "RANGED_VALUE_PIN_PURCHASE"
	PRODUCTTYPES_RANGED_VALUE_PAYMENT      ProductTypes = "RANGED_VALUE_PAYMENT"
)

// All allowed values of ProductTypes enum
var AllowedProductTypesEnumValues = []ProductTypes{
...
func (v *ProductTypes) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := ProductTypes(value)
	for _, existing := range AllowedProductTypesEnumValues {
	...
	return fmt.Errorf("%+v is not a valid ProductTypes", value)
}

// NewProductTypesFromValue returns a pointer to a valid ProductTypes
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewProductTypesFromValue(v string) (*ProductTypes, error) {
	ev := ProductTypes(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for ProductTypes: valid values are %v", v, AllowedProductTypesEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v ProductTypes) IsValid() bool {
	for _, existing := range AllowedProductTypesEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to ProductTypes value
func (v ProductTypes) Ptr() *ProductTypes {
	return &v
}

type NullableProductTypes struct {
	value *ProductTypes
	isSet bool
}

func (v NullableProductTypes) Get() *ProductTypes {
	return v.value
}

func (v *NullableProductTypes) Set(val *ProductTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableProductTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableProductTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductTypes(val *ProductTypes) *NullableProductTypes {
	return &NullableProductTypes{value: val, isSet: true}
}

func (v NullableProductTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductTypes) UnmarshalJSON(src []byte) error {
	v.isSet = true
