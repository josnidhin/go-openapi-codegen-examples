...
// checks if the FixedBenefitAmount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FixedBenefitAmount{}
...
func (o FixedBenefitAmount) MarshalJSON() ([]byte, error) {
...
func (o FixedBenefitAmount) ToMap() (map[string]interface{}, error) {
...
type NullableFixedBenefitAmount struct {
	value *FixedBenefitAmount
	isSet bool
}

func (v NullableFixedBenefitAmount) Get() *FixedBenefitAmount {
	return v.value
}

func (v *NullableFixedBenefitAmount) Set(val *FixedBenefitAmount) {
	v.value = val
	v.isSet = true
}

func (v NullableFixedBenefitAmount) IsSet() bool {
	return v.isSet
}

func (v *NullableFixedBenefitAmount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFixedBenefitAmount(val *FixedBenefitAmount) *NullableFixedBenefitAmount {
	return &NullableFixedBenefitAmount{value: val, isSet: true}
}

func (v NullableFixedBenefitAmount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFixedBenefitAmount) UnmarshalJSON(src []byte) error {
	v.isSet = true
