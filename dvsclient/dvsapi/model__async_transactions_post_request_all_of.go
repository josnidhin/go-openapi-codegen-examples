...
// AsyncTransactionsPostRequestAllOf struct for AsyncTransactionsPostRequestAllOf
type AsyncTransactionsPostRequestAllOf struct {
...
func NewAsyncTransactionsPostRequestAllOf() *AsyncTransactionsPostRequestAllOf {
	this := AsyncTransactionsPostRequestAllOf{}
	return &this
}
...
func (o AsyncTransactionsPostRequestAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAsyncTransactionsPostRequestAllOf struct {
	value *AsyncTransactionsPostRequestAllOf
	isSet bool
}

func (v NullableAsyncTransactionsPostRequestAllOf) Get() *AsyncTransactionsPostRequestAllOf {
	return v.value
}

func (v *NullableAsyncTransactionsPostRequestAllOf) Set(val *AsyncTransactionsPostRequestAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAsyncTransactionsPostRequestAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAsyncTransactionsPostRequestAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAsyncTransactionsPostRequestAllOf(val *AsyncTransactionsPostRequestAllOf) *NullableAsyncTransactionsPostRequestAllOf {
	return &NullableAsyncTransactionsPostRequestAllOf{value: val, isSet: true}
}

func (v NullableAsyncTransactionsPostRequestAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAsyncTransactionsPostRequestAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
