...
// checks if the PromotionOperatorCountry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionOperatorCountry{}
...
func (o PromotionOperatorCountry) MarshalJSON() ([]byte, error) {
...
func (o PromotionOperatorCountry) ToMap() (map[string]interface{}, error) {
...
type NullablePromotionOperatorCountry struct {
	value *PromotionOperatorCountry
	isSet bool
}

func (v NullablePromotionOperatorCountry) Get() *PromotionOperatorCountry {
	return v.value
}

func (v *NullablePromotionOperatorCountry) Set(val *PromotionOperatorCountry) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionOperatorCountry) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionOperatorCountry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotionOperatorCountry(val *PromotionOperatorCountry) *NullablePromotionOperatorCountry {
	return &NullablePromotionOperatorCountry{value: val, isSet: true}
}

func (v NullablePromotionOperatorCountry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotionOperatorCountry) UnmarshalJSON(src []byte) error {
	v.isSet = true
