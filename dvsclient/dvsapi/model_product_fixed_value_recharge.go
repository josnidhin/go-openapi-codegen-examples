...
// checks if the ProductFixedValueRecharge type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductFixedValueRecharge{}
...
func (o ProductFixedValueRecharge) ToMap() (map[string]interface{}, error) {
