...
// checks if the TransactionPin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionPin{}
...
func (o TransactionPin) MarshalJSON() ([]byte, error) {
...
func (o TransactionPin) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionPin struct {
	value *TransactionPin
	isSet bool
}

func (v NullableTransactionPin) Get() *TransactionPin {
	return v.value
}

func (v *NullableTransactionPin) Set(val *TransactionPin) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionPin) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionPin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionPin(val *TransactionPin) *NullableTransactionPin {
	return &NullableTransactionPin{value: val, isSet: true}
}

func (v NullableTransactionPin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionPin) UnmarshalJSON(src []byte) error {
	v.isSet = true
