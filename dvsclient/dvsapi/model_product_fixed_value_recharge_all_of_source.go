...
// checks if the ProductFixedValueRechargeAllOfSource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductFixedValueRechargeAllOfSource{}
...
func NewProductFixedValueRechargeAllOfSource(unitType UnitTypes, unit string, amount float32) *ProductFixedValueRechargeAllOfSource {
	this := ProductFixedValueRechargeAllOfSource{}
...
func (o ProductFixedValueRechargeAllOfSource) MarshalJSON() ([]byte, error) {
...
func (o ProductFixedValueRechargeAllOfSource) ToMap() (map[string]interface{}, error) {
...
type NullableProductFixedValueRechargeAllOfSource struct {
	value *ProductFixedValueRechargeAllOfSource
	isSet bool
}

func (v NullableProductFixedValueRechargeAllOfSource) Get() *ProductFixedValueRechargeAllOfSource {
	return v.value
}

func (v *NullableProductFixedValueRechargeAllOfSource) Set(val *ProductFixedValueRechargeAllOfSource) {
	v.value = val
	v.isSet = true
}

func (v NullableProductFixedValueRechargeAllOfSource) IsSet() bool {
	return v.isSet
}

func (v *NullableProductFixedValueRechargeAllOfSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductFixedValueRechargeAllOfSource(val *ProductFixedValueRechargeAllOfSource) *NullableProductFixedValueRechargeAllOfSource {
	return &NullableProductFixedValueRechargeAllOfSource{value: val, isSet: true}
}

func (v NullableProductFixedValueRechargeAllOfSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductFixedValueRechargeAllOfSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
