...
// checks if the ProductRangedValuePinPurchaseAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductRangedValuePinPurchaseAllOf{}

// ProductRangedValuePinPurchaseAllOf struct for ProductRangedValuePinPurchaseAllOf
type ProductRangedValuePinPurchaseAllOf struct {
...
func NewProductRangedValuePinPurchaseAllOf(type_ string, validity NullableProductFixedValueRechargeAllOfValidity, requiredDebitPartyIdentifierFields [][]string, requiredCreditPartyIdentifierFields [][]string, requiredSenderFields [][]string, requiredBeneficiaryFields [][]string, requiredStatementIdentifierFields [][]string, requiredAdditionalIdentifierFields [][]string, acceptedCalculationModes []CalculationModes, availabilityZones []AvailabilityZones, source ProductRangedValueRechargeAllOfSource, destination ProductRangedValueRechargeAllOfDestination, prices ProductRangedValueRechargeAllOfPrices, rates Rates, pin PIN, benefits []RangedBenefit, promotions []ProductPromotion) *ProductRangedValuePinPurchaseAllOf {
	this := ProductRangedValuePinPurchaseAllOf{}
	this.Type = type_
...
func (o *ProductRangedValuePinPurchaseAllOf) GetRequiredCreditPartyIdentifierFieldsOk() ([][]string, bool) {
	if o == nil || IsNil(o.RequiredCreditPartyIdentifierFields) {
		return nil, false
	}
...
// If the value is explicit nil, the zero value for [][]string will be returned
func (o *ProductRangedValuePinPurchaseAllOf) GetRequiredAdditionalIdentifierFields() [][]string {
	if o == nil {
		var ret [][]string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ProductRangedValuePinPurchaseAllOf) GetRequiredAdditionalIdentifierFieldsOk() ([][]string, bool) {
...
func (o *ProductRangedValuePinPurchaseAllOf) SetRequiredAdditionalIdentifierFields(v [][]string) {
...
func (o ProductRangedValuePinPurchaseAllOf) MarshalJSON() ([]byte, error) {
...
func (o ProductRangedValuePinPurchaseAllOf) ToMap() (map[string]interface{}, error) {
	...
	if o.RequiredCreditPartyIdentifierFields != nil {
...
type NullableProductRangedValuePinPurchaseAllOf struct {
	value *ProductRangedValuePinPurchaseAllOf
	isSet bool
}

func (v NullableProductRangedValuePinPurchaseAllOf) Get() *ProductRangedValuePinPurchaseAllOf {
	return v.value
}

func (v *NullableProductRangedValuePinPurchaseAllOf) Set(val *ProductRangedValuePinPurchaseAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableProductRangedValuePinPurchaseAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableProductRangedValuePinPurchaseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductRangedValuePinPurchaseAllOf(val *ProductRangedValuePinPurchaseAllOf) *NullableProductRangedValuePinPurchaseAllOf {
	return &NullableProductRangedValuePinPurchaseAllOf{value: val, isSet: true}
}

func (v NullableProductRangedValuePinPurchaseAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductRangedValuePinPurchaseAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
