...
// checks if the TransactionStatementIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionStatementIdentifier{}

// TransactionStatementIdentifier struct for TransactionStatementIdentifier
type TransactionStatementIdentifier struct {
...
func NewTransactionStatementIdentifier() *TransactionStatementIdentifier {
	this := TransactionStatementIdentifier{}
	return &this
}
...
func (o TransactionStatementIdentifier) MarshalJSON() ([]byte, error) {
...
func (o TransactionStatementIdentifier) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionStatementIdentifier struct {
	value *TransactionStatementIdentifier
	isSet bool
}

func (v NullableTransactionStatementIdentifier) Get() *TransactionStatementIdentifier {
	return v.value
}

func (v *NullableTransactionStatementIdentifier) Set(val *TransactionStatementIdentifier) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionStatementIdentifier) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionStatementIdentifier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionStatementIdentifier(val *TransactionStatementIdentifier) *NullableTransactionStatementIdentifier {
	return &NullableTransactionStatementIdentifier{value: val, isSet: true}
}

func (v NullableTransactionStatementIdentifier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionStatementIdentifier) UnmarshalJSON(src []byte) error {
	v.isSet = true
