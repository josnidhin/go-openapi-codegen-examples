...
// checks if the RangeBenefitAmountWithoutIncrementPromotionBonus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangeBenefitAmountWithoutIncrementPromotionBonus{}

// RangeBenefitAmountWithoutIncrementPromotionBonus struct for RangeBenefitAmountWithoutIncrementPromotionBonus
type RangeBenefitAmountWithoutIncrementPromotionBonus struct {
...
func NewRangeBenefitAmountWithoutIncrementPromotionBonus(min float32, max float32) *RangeBenefitAmountWithoutIncrementPromotionBonus {
	this := RangeBenefitAmountWithoutIncrementPromotionBonus{}
	this.Min = min
	this.Max = max
	return &this
}
...
func (o RangeBenefitAmountWithoutIncrementPromotionBonus) MarshalJSON() ([]byte, error) {
...
func (o RangeBenefitAmountWithoutIncrementPromotionBonus) ToMap() (map[string]interface{}, error) {
...
type NullableRangeBenefitAmountWithoutIncrementPromotionBonus struct {
	value *RangeBenefitAmountWithoutIncrementPromotionBonus
	isSet bool
}

func (v NullableRangeBenefitAmountWithoutIncrementPromotionBonus) Get() *RangeBenefitAmountWithoutIncrementPromotionBonus {
	return v.value
}

func (v *NullableRangeBenefitAmountWithoutIncrementPromotionBonus) Set(val *RangeBenefitAmountWithoutIncrementPromotionBonus) {
	v.value = val
	v.isSet = true
}

func (v NullableRangeBenefitAmountWithoutIncrementPromotionBonus) IsSet() bool {
	return v.isSet
}

func (v *NullableRangeBenefitAmountWithoutIncrementPromotionBonus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangeBenefitAmountWithoutIncrementPromotionBonus(val *RangeBenefitAmountWithoutIncrementPromotionBonus) *NullableRangeBenefitAmountWithoutIncrementPromotionBonus {
	return &NullableRangeBenefitAmountWithoutIncrementPromotionBonus{value: val, isSet: true}
}

func (v NullableRangeBenefitAmountWithoutIncrementPromotionBonus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangeBenefitAmountWithoutIncrementPromotionBonus) UnmarshalJSON(src []byte) error {
	v.isSet = true
