...
// checks if the ProductFixedValuePinPurchaseAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductFixedValuePinPurchaseAllOf{}

// ProductFixedValuePinPurchaseAllOf struct for ProductFixedValuePinPurchaseAllOf
type ProductFixedValuePinPurchaseAllOf struct {
...
func NewProductFixedValuePinPurchaseAllOf(type_ string, validity NullableProductFixedValueRechargeAllOfValidity, requiredDebitPartyIdentifierFields [][]string, requiredCreditPartyIdentifierFields [][]string, requiredSenderFields [][]string, requiredBeneficiaryFields [][]string, requiredStatementIdentifierFields [][]string, requiredAdditionalIdentifierFields [][]string, availabilityZones []AvailabilityZones, source ProductFixedValueRechargeAllOfSource, destination ProductFixedValueRechargeAllOfSource, prices ProductFixedValueRechargeAllOfPrices, rates Rates, pin PIN, benefits []FixedBenefit, promotions []ProductPromotion) *ProductFixedValuePinPurchaseAllOf {
	this := ProductFixedValuePinPurchaseAllOf{}
	this.Type = type_
...
func (o ProductFixedValuePinPurchaseAllOf) MarshalJSON() ([]byte, error) {
...
func (o ProductFixedValuePinPurchaseAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableProductFixedValuePinPurchaseAllOf struct {
	value *ProductFixedValuePinPurchaseAllOf
	isSet bool
}

func (v NullableProductFixedValuePinPurchaseAllOf) Get() *ProductFixedValuePinPurchaseAllOf {
	return v.value
}

func (v *NullableProductFixedValuePinPurchaseAllOf) Set(val *ProductFixedValuePinPurchaseAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableProductFixedValuePinPurchaseAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableProductFixedValuePinPurchaseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductFixedValuePinPurchaseAllOf(val *ProductFixedValuePinPurchaseAllOf) *NullableProductFixedValuePinPurchaseAllOf {
	return &NullableProductFixedValuePinPurchaseAllOf{value: val, isSet: true}
}

func (v NullableProductFixedValuePinPurchaseAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductFixedValuePinPurchaseAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
