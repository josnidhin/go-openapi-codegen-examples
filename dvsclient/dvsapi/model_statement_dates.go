...
// checks if the StatementDates type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatementDates{}
...
func (o StatementDates) MarshalJSON() ([]byte, error) {
...
func (o StatementDates) ToMap() (map[string]interface{}, error) {
...
type NullableStatementDates struct {
	value *StatementDates
	isSet bool
}

func (v NullableStatementDates) Get() *StatementDates {
	return v.value
}

func (v *NullableStatementDates) Set(val *StatementDates) {
	v.value = val
	v.isSet = true
}

func (v NullableStatementDates) IsSet() bool {
	return v.isSet
}

func (v *NullableStatementDates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatementDates(val *StatementDates) *NullableStatementDates {
	return &NullableStatementDates{value: val, isSet: true}
}

func (v NullableStatementDates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatementDates) UnmarshalJSON(src []byte) error {
	v.isSet = true
